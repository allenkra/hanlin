...
int main() {
  ...
  15:	6a 0e                	push   $0xe
  17:	6a 03                	push   $0x3
  19:	68 a0 0f 00 00       	push   $0xfa0
  1e:	68 00 00 02 60       	push   $0x60020000
  23:	e8 4b 03 00 00       	call   373 <mmap>
    if (mem == (void *)-1) {
	    goto failed;
    }
    if (mem != (void *)addr) {
  28:	83 c4 20             	add    $0x20,%esp
  2b:	3d 00 00 02 60       	cmp    $0x60020000,%eax
  30:	74 14                	je     46 <main+0x46>
// success:
...
failed:
  ...
  35:	68 77 07 00 00       	push   $0x777
  3a:	6a 01                	push   $0x1
  3c:	e8 ff 03 00 00       	call   440 <printf>
    exit();
  41:	e8 8d 02 00 00       	call   2d3 <exit>
    memchar[0] = 'a'; memchar[1] = 'a';
  46:	66 c7 05 00 00 02 60 	movw   $0x6161,0x60020000
  4d:	61 61 
    int ret = munmap(mem, len);
  4f:	52                   	push   %edx
  50:	52                   	push   %edx
  51:	68 a0 0f 00 00       	push   $0xfa0
  56:	68 00 00 02 60       	push   $0x60020000
  5b:	e8 1b 03 00 00       	call   37b <munmap>
    if (ret < 0) {
  60:	83 c4 10             	add    $0x10,%esp
  63:	85 c0                	test   %eax,%eax
  65:	78 cb                	js     32 <main+0x32>
    printf(1, "MMAP\t SUCCESS\n");
  67:	50                   	push   %eax
  68:	50                   	push   %eax
  69:	68 68 07 00 00       	push   $0x768
  6e:	6a 01                	push   $0x1
  70:	e8 cb 03 00 00       	call   440 <printf>
    exit();
  75:	e8 59 02 00 00       	call   2d3 <exit>
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 85 07 00 00       	mov    $0x785,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 8c 0a 00 00       	mov    0xa8c,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 8c 0a 00 00    	mov    0xa8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 8c 0a 00 00    	mov    0xa8c,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 8c 0a 00 00 90 	movl   $0xa90,0xa8c
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 90 0a 00 00       	mov    $0xa90,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 90 0a 00 00 90 	movl   $0xa90,0xa90
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 94 0a 00 00 00 	movl   $0x0,0xa94
 752:	00 00 00 
    if(p->s.size >= nunits){
