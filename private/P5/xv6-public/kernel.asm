...
80100028:	bc d0 f4 11 80       	mov    $0x8011f4d0,%esp
...
8010021b:	e8 30 44 00 00       	call   80104650 <acquire>
  b->refcnt--;
...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 7f 43 00 00       	jmp    801045f0 <release>
    panic("brelse");
...
801002a0:	e8 ab 43 00 00       	call   80104650 <acquire>
  while(n > 0){
...
801002f6:	e8 f5 42 00 00       	call   801045f0 <release>
        ilock(ip);
801002fb:	5a                   	pop    %edx
...
8010034c:	e8 9f 42 00 00       	call   801045f0 <release>
  ilock(ip);
80100351:	58                   	pop    %eax
...
8010041a:	e8 41 5b 00 00       	call   80105f60 <uartputc>
...
80100505:	e8 56 5a 00 00       	call   80105f60 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 4a 5a 00 00       	call   80105f60 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 3e 5a 00 00       	call   80105f60 <uartputc>
...
801005ab:	e8 a0 40 00 00       	call   80104650 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 07 40 00 00       	call   801045f0 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 63 3e 00 00       	call   80104650 <acquire>
...
8010085b:	e8 90 3d 00 00       	call   801045f0 <release>
...
80100893:	e8 b8 3d 00 00       	call   80104650 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 1b 3c 00 00       	call   801045f0 <release>
  if(doprocdump) {
...
80100a70:	e8 0b 3a 00 00       	call   80104480 <initlock>
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 b7 65 00 00       	call   801070f0 <setupkvm>
...
80100ba3:	e8 68 63 00 00       	call   80106f10 <allocuvm>
...
80100bd9:	e8 42 62 00 00       	call   80106e20 <loaduvm>
...
80100c1b:	e8 50 64 00 00       	call   80107070 <freevm>
  if(ip){
...
80100c62:	e8 a9 62 00 00       	call   80106f10 <allocuvm>
...
80100cf8:	e8 63 66 00 00       	call   80107360 <copyout>
...
80100d11:	e8 5a 63 00 00       	call   80107070 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 f8 65 00 00       	call   80107360 <copyout>
...
80100dcd:	e8 be 5e 00 00       	call   80106c90 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 96 62 00 00       	call   80107070 <freevm>
  return 0;
...
80100e20:	e8 5b 36 00 00       	call   80104480 <initlock>
}
...
80100e71:	e8 7a 37 00 00       	call   801045f0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 61 37 00 00       	call   801045f0 <release>
}
...
80100eaf:	e8 9c 37 00 00       	call   80104650 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 1f 37 00 00       	call   801045f0 <release>
  return f;
}
...
80100f01:	e8 4a 37 00 00       	call   80104650 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 af 36 00 00       	call   801045f0 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 7d 36 00 00       	jmp    801045f0 <release>
...
8010136a:	e8 e1 32 00 00       	call   80104650 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 14 32 00 00       	call   801045f0 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 e6 31 00 00       	call   801045f0 <release>
      return ip;
...
80101541:	e8 6a 32 00 00       	call   801047b0 <memmove>
  brelse(bp);
...
80101576:	e8 05 2f 00 00       	call   80104480 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 bc 2d 00 00       	call   80104350 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 ef 31 00 00       	call   801047b0 <memmove>
  brelse(bp);
...
8010168e:	e8 7d 30 00 00       	call   80104710 <memset>
      dip->type = type;
...
80101731:	e8 7a 30 00 00       	call   801047b0 <memmove>
  log_write(bp);
...
8010175f:	e8 ec 2e 00 00       	call   80104650 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 7c 2e 00 00       	call   801045f0 <release>
}
...
801017a2:	e8 e9 2b 00 00       	call   80104390 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 93 2f 00 00       	call   801047b0 <memmove>
    brelse(bp);
...
80101873:	e8 b8 2b 00 00       	call   80104430 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 5c 2b 00 00       	jmp    801043f0 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 cb 2a 00 00       	call   80104390 <acquiresleep>
...
801018da:	e8 11 2b 00 00       	call   801043f0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 65 2d 00 00       	call   80104650 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 eb 2c 00 00       	jmp    801045f0 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 3b 2d 00 00       	call   80104650 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 cc 2c 00 00       	call   801045f0 <release>
    if(r == 1){
...
80101a23:	e8 08 2a 00 00       	call   80104430 <holdingsleep>
...
80101a3a:	e8 b1 29 00 00       	call   801043f0 <releasesleep>
  iput(ip);
...
80101b37:	e8 74 2c 00 00       	call   801047b0 <memmove>
    brelse(bp);
...
80101c33:	e8 78 2b 00 00       	call   801047b0 <memmove>
    log_write(bp);
...
80101cce:	e8 4d 2b 00 00       	call   80104820 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 ee 2a 00 00       	call   80104820 <strncmp>
      continue;
...
80101dba:	e8 91 28 00 00       	call   80104650 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 21 28 00 00       	call   801045f0 <release>
...
80101e8c:	e8 9f 25 00 00       	call   80104430 <holdingsleep>
...
80101eae:	e8 3d 25 00 00       	call   801043f0 <releasesleep>
  iput(ip);
...
80101edb:	e8 d0 28 00 00       	call   801047b0 <memmove>
    name[len] = 0;
...
80101f2b:	e8 00 25 00 00       	call   80104430 <holdingsleep>
...
80101f4a:	e8 a1 24 00 00       	call   801043f0 <releasesleep>
  iput(ip);
...
80101f6d:	e8 be 24 00 00       	call   80104430 <holdingsleep>
...
80101f90:	e8 9b 24 00 00       	call   80104430 <holdingsleep>
...
80101fa7:	e8 44 24 00 00       	call   801043f0 <releasesleep>
}
...
8010203d:	e8 2e 28 00 00       	call   80104870 <strncpy>
...
801021d0:	e8 ab 22 00 00       	call   80104480 <initlock>
...
8010224e:	e8 fd 23 00 00       	call   80104650 <acquire>
...
801022cb:	e8 20 23 00 00       	call   801045f0 <release>
...
801022ee:	e8 3d 21 00 00       	call   80104430 <holdingsleep>
...
80102328:	e8 23 23 00 00       	call   80104650 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 65 22 00 00       	jmp    801045f0 <release>
...
801024d2:	81 fb d0 f4 11 80    	cmp    $0x8011f4d0,%ebx
...
801024f2:	e8 19 22 00 00       	call   80104710 <memset>
...
80102528:	e8 23 21 00 00       	call   80104650 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 a8 20 00 00       	jmp    801045f0 <release>
    panic("kfree");
...
80102625:	e8 56 1e 00 00       	call   80104480 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 98 1f 00 00       	call   80104650 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 0a 1f 00 00       	call   801045f0 <release>
  return (char*)r;
...
80102af7:	e8 64 1c 00 00       	call   80104760 <memcmp>
...
80102c24:	e8 87 1b 00 00       	call   801047b0 <memmove>
...
80102cd4:	e8 a7 17 00 00       	call   80104480 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 e0 18 00 00       	call   80104650 <acquire>
...
80102dbc:	e8 2f 18 00 00       	call   801045f0 <release>
      break;
    }
  }
}
...
80102dde:	e8 6d 18 00 00       	call   80104650 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 cf 17 00 00       	call   801045f0 <release>
}
...
80102e36:	e8 15 18 00 00       	call   80104650 <acquire>
    wakeup(&log);
...
80102e58:	e8 93 17 00 00       	call   801045f0 <release>
...
80102eb4:	e8 f7 18 00 00       	call   801047b0 <memmove>
...
80102f14:	e8 d7 16 00 00       	call   801045f0 <release>
...
80102f76:	e8 d5 16 00 00       	call   80104650 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 36 16 00 00       	jmp    801045f0 <release>
...
80103022:	e8 49 2b 00 00       	call   80105b70 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 35 3c 00 00       	call   80106c80 <switchkvm>
  seginit();
8010304b:	e8 a0 3b 00 00       	call   80106bf0 <seginit>
  lapicinit();
...
80103077:	68 d0 f4 11 80       	push   $0x8011f4d0
8010307c:	e8 8f f5 ff ff       	call   80102610 <kinit1>
  kvmalloc();      // kernel page table
80103081:	e8 ea 40 00 00       	call   80107170 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 5b 3b 00 00       	call   80106bf0 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 d7 2d 00 00       	call   80105e80 <uartinit>
  pinit();         // process table
801030a9:	e8 32 08 00 00       	call   801038e0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 3d 2a 00 00       	call   80105af0 <tvinit>
  binit();         // buffer cache
...
801030d4:	e8 d7 16 00 00       	call   801047b0 <memmove>
...
801031c4:	e8 97 15 00 00       	call   80104760 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 dc 14 00 00       	call   80104760 <memcmp>
...
801033c8:	e8 93 13 00 00       	call   80104760 <memcmp>
...
801034a9:	e8 d2 0f 00 00       	call   80104480 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 0c 11 00 00       	call   80104650 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 67 10 00 00       	jmp    801045f0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 57 10 00 00       	call   801045f0 <release>
    kfree((char*)p);
...
801035dd:	e8 6e 10 00 00       	call   80104650 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 7f 0f 00 00       	call   801045f0 <release>
        return -1;
...
801036e6:	e8 65 0f 00 00       	call   80104650 <acquire>
...
8010377e:	e8 6d 0e 00 00       	call   801045f0 <release>
  return i;
...
80103799:	e8 52 0e 00 00       	call   801045f0 <release>
      return -1;
...
801037c1:	e8 8a 0e 00 00       	call   80104650 <acquire>
801037c6:	83 c4 10             	add    $0x10,%esp
801037c9:	eb 13                	jmp    801037de <allocproc+0x2e>
801037cb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801037cf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d0:	81 c3 fc 02 00 00    	add    $0x2fc,%ebx
801037d6:	81 fb 54 dc 11 80    	cmp    $0x8011dc54,%ebx
...
801037ff:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103805:	e8 e6 0d 00 00       	call   801045f0 <release>
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 db 5a 10 80 	movl   $0x80105adb,0x14(%eax)
  p->context = (struct context*)sp;
...
80103839:	e8 d2 0e 00 00       	call   80104710 <memset>
...
80103862:	e8 89 0d 00 00       	call   801045f0 <release>
}
...
8010389b:	e8 50 0d 00 00       	call   801045f0 <release>
...
801038e6:	68 e0 7a 10 80       	push   $0x80107ae0
801038eb:	68 20 1d 11 80       	push   $0x80111d20
801038f0:	e8 8b 0b 00 00       	call   80104480 <initlock>
}
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 74 0b 00 00       	call   80104500 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 b4 0b 00 00       	call   80104550 <popcli>
}
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 54 dc 11 80       	mov    %eax,0x8011dc54
  if((p->pgdir = setupkvm()) == 0)
801039c3:	e8 28 37 00 00       	call   801070f0 <setupkvm>
...
801039e1:	e8 ba 33 00 00       	call   80106da0 <inituvm>
...
80103a4f:	68 10 7b 10 80       	push   $0x80107b10
80103a54:	50                   	push   %eax
80103a55:	e8 76 0e 00 00       	call   801048d0 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 19 7b 10 80 	movl   $0x80107b19,(%esp)
...
80103a93:	68 f7 7a 10 80       	push   $0x80107af7
...
80103aa5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aa8:	e8 53 0a 00 00       	call   80104500 <pushcli>
  c = mycpu();
80103aad:	e8 4e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab8:	e8 93 0a 00 00       	call   80104550 <popcli>
  sz = curproc->sz;
...
80103acb:	e8 c0 31 00 00       	call   80106c90 <switchuvm>
  return 0;
...
80103aea:	e8 21 34 00 00       	call   80106f10 <allocuvm>
...
80103b0a:	e8 31 35 00 00       	call   80107040 <deallocuvm>
...
80103b26:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b29:	e8 d2 09 00 00       	call   80104500 <pushcli>
  c = mycpu();
80103b2e:	e8 cd fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b33:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b39:	e8 12 0a 00 00       	call   80104550 <popcli>
  if((np = allocproc()) == 0){
...
80103b58:	e8 83 36 00 00       	call   801071e0 <copyuvm>
...
80103bd1:	e8 fa 0c 00 00       	call   801048d0 <safestrcpy>
  pid = np->pid;
...
80103bf3:	e8 f8 09 00 00       	call   801045f0 <release>
  return pid;
...
80103c6e:	e8 dd 09 00 00       	call   80104650 <acquire>
...
80103c90:	e8 fb 2f 00 00       	call   80106c90 <switchuvm>
...
80103c9b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ca2:	e8 84 0c 00 00       	call   8010492b <swtch>
      switchkvm();
80103ca7:	e8 d4 2f 00 00       	call   80106c80 <switchkvm>
      c->proc = 0;
80103cac:	83 c4 10             	add    $0x10,%esp
80103caf:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103cb6:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb9:	81 c3 fc 02 00 00    	add    $0x2fc,%ebx
80103cbf:	81 fb 54 dc 11 80    	cmp    $0x8011dc54,%ebx
80103cc5:	75 b9                	jne    80103c80 <scheduler+0x40>
    release(&ptable.lock);
80103cc7:	83 ec 0c             	sub    $0xc,%esp
80103cca:	68 20 1d 11 80       	push   $0x80111d20
80103ccf:	e8 1c 09 00 00       	call   801045f0 <release>
    sti();
...
80103ce4:	53                   	push   %ebx
  pushcli();
80103ce5:	e8 16 08 00 00       	call   80104500 <pushcli>
  c = mycpu();
...
80103d02:	e8 a9 08 00 00       	call   801045b0 <holding>
...
80103d43:	e8 e3 0b 00 00       	call   8010492b <swtch>
  mycpu()->intena = intena;
...
80103da9:	e8 d2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dae:	39 05 54 dc 11 80    	cmp    %eax,0x8011dc54
...
80103e0a:	e8 41 08 00 00       	call   80104650 <acquire>
...
80103e20:	05 fc 02 00 00       	add    $0x2fc,%eax
80103e25:	3d 54 dc 11 80       	cmp    $0x8011dc54,%eax
...
80103e37:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e3e:	05 fc 02 00 00       	add    $0x2fc,%eax
80103e43:	3d 54 dc 11 80       	cmp    $0x8011dc54,%eax
80103e48:	75 e2                	jne    80103e2c <exit+0x8c>
      p->parent = initproc;
80103e4a:	8b 0d 54 dc 11 80    	mov    0x8011dc54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e60:	81 c2 fc 02 00 00    	add    $0x2fc,%edx
80103e66:	81 fa 54 dc 11 80    	cmp    $0x8011dc54,%edx
...
80103e87:	90                   	nop
80103e88:	05 fc 02 00 00       	add    $0x2fc,%eax
80103e8d:	3d 54 dc 11 80       	cmp    $0x8011dc54,%eax
...
80103eb7:	68 68 7b 10 80       	push   $0x80107b68
80103ebc:	e8 bf c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ec1:	83 ec 0c             	sub    $0xc,%esp
80103ec4:	68 5b 7b 10 80       	push   $0x80107b5b
...
80103f07:	90                   	nop
80103f08:	81 c3 fc 02 00 00    	add    $0x2fc,%ebx
80103f0e:	81 fb 54 dc 11 80    	cmp    $0x8011dc54,%ebx
...
80103f1f:	74 5f                	je     80103f80 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f21:	81 c3 fc 02 00 00    	add    $0x2fc,%ebx
      havekids = 1;
80103f27:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f2c:	81 fb 54 dc 11 80    	cmp    $0x8011dc54,%ebx
...
80103f41:	0f 85 8f 00 00 00    	jne    80103fd6 <wait+0x106>
  pushcli();
80103f47:	e8 b4 05 00 00       	call   80104500 <pushcli>
  c = mycpu();
80103f4c:	e8 af f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f51:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f57:	e8 f4 05 00 00       	call   80104550 <popcli>
  if(p == 0)
...
80103f99:	e8 d2 30 00 00       	call   80107070 <freevm>
        p->pid = 0;
...
80103fc5:	e8 26 06 00 00       	call   801045f0 <release>
        return pid;
...
8010400c:	e8 3f 06 00 00       	call   80104650 <acquire>
  pushcli();
80104011:	e8 ea 04 00 00       	call   80104500 <pushcli>
  c = mycpu();
80104016:	e8 e5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010401b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104021:	e8 2a 05 00 00       	call   80104550 <popcli>
...
80104039:	e8 b2 05 00 00       	call   801045f0 <release>
}
...
8010405c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010405f:	e8 9c 04 00 00       	call   80104500 <pushcli>
  c = mycpu();
80104064:	e8 97 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104069:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010406f:	e8 dc 04 00 00       	call   80104550 <popcli>
  if(p == 0)
...
80104090:	e8 bb 05 00 00       	call   80104650 <acquire>
    release(lk);
80104095:	89 34 24             	mov    %esi,(%esp)
80104098:	e8 53 05 00 00       	call   801045f0 <release>
  p->chan = chan;
...
801040ba:	e8 31 05 00 00       	call   801045f0 <release>
    acquire(lk);
...
801040cb:	5d                   	pop    %ebp
    acquire(lk);
801040cc:	e9 7f 05 00 00       	jmp    80104650 <acquire>
...
801040f9:	68 7a 7b 10 80       	push   $0x80107b7a
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 74 7b 10 80       	push   $0x80107b74
...
8010411f:	e8 2c 05 00 00       	call   80104650 <acquire>
80104124:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104127:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010412c:	eb 0e                	jmp    8010413c <wakeup+0x2c>
8010412e:	66 90                	xchg   %ax,%ax
80104130:	05 fc 02 00 00       	add    $0x2fc,%eax
80104135:	3d 54 dc 11 80       	cmp    $0x8011dc54,%eax
...
80104147:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010414e:	05 fc 02 00 00       	add    $0x2fc,%eax
80104153:	3d 54 dc 11 80       	cmp    $0x8011dc54,%eax
...
80104164:	c9                   	leave  
  release(&ptable.lock);
80104165:	e9 86 04 00 00       	jmp    801045f0 <release>
...
8010417f:	e8 cc 04 00 00       	call   80104650 <acquire>
...
80104190:	05 fc 02 00 00       	add    $0x2fc,%eax
80104195:	3d 54 dc 11 80       	cmp    $0x8011dc54,%eax
...
801041bd:	e8 2e 04 00 00       	call   801045f0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041d8:	e8 13 04 00 00       	call   801045f0 <release>
}
...
8010420b:	68 67 7f 10 80       	push   $0x80107f67
80104210:	e8 8b c4 ff ff       	call   801006a0 <cprintf>
80104215:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104218:	81 c3 fc 02 00 00    	add    $0x2fc,%ebx
8010421e:	81 fb c0 dc 11 80    	cmp    $0x8011dcc0,%ebx
...
8010422f:	74 e7                	je     80104218 <procdump+0x28>
      state = "???";
80104231:	ba 8b 7b 10 80       	mov    $0x80107b8b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104236:	83 f8 05             	cmp    $0x5,%eax
80104239:	77 11                	ja     8010424c <procdump+0x5c>
8010423b:	8b 14 85 ec 7b 10 80 	mov    -0x7fef8414(,%eax,4),%edx
      state = "???";
80104242:	b8 8b 7b 10 80       	mov    $0x80107b8b,%eax
...
80104251:	68 8f 7b 10 80       	push   $0x80107b8f
...
80104278:	e8 23 02 00 00       	call   801044a0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042b9:	8b 5d 14             	mov    0x14(%ebp),%ebx
801042bc:	8b 75 08             	mov    0x8(%ebp),%esi

  void* addrfound = (void*)-1;
  if (flags & MAP_FIXED) {
801042bf:	f6 c3 08             	test   $0x8,%bl
801042c2:	74 10                	je     801042d4 <mmap+0x24>
    // MAP_FIXED
    // address fault
    if ((int)addr > KERNBASE || (int)addr < MMAPBASE){
801042c4:	81 fe 00 00 00 80    	cmp    $0x80000000,%esi
801042ca:	77 3b                	ja     80104307 <mmap+0x57>
801042cc:	81 fe ff ff ff 5f    	cmp    $0x5fffffff,%esi
801042d2:	7e 33                	jle    80104307 <mmap+0x57>
  pushcli();
801042d4:	e8 27 02 00 00       	call   80104500 <pushcli>
  c = mycpu();
801042d9:	e8 22 f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801042de:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
801042e4:	e8 67 02 00 00       	call   80104550 <popcli>
      return (void*)-1;
    }
  }
...
801042ec:	ff 75 0c             	push   0xc(%ebp)
801042ef:	56                   	push   %esi
801042f0:	ff 77 04             	push   0x4(%edi)
801042f3:	e8 18 32 00 00       	call   80107510 <is_region_free>
801042f8:	83 c4 10             	add    $0x10,%esp
801042fb:	85 c0                	test   %eax,%eax
801042fd:	74 08                	je     80104307 <mmap+0x57>
  }
  ...
  if (flags & MAP_ANON) {
    ...
    // Map the pages
    if (flags & MAP_FIXED) {
801042ff:	83 e3 0c             	and    $0xc,%ebx
80104302:	83 fb 0c             	cmp    $0xc,%ebx
80104305:	74 11                	je     80104318 <mmap+0x68>
    } else {
...
80104314:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  pushcli();
80104318:	e8 e3 01 00 00       	call   80104500 <pushcli>
  c = mycpu();
8010431d:	e8 de f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104322:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104328:	e8 23 02 00 00       	call   80104550 <popcli>
      addrfound = map_pages(myproc()->pgdir, addr, length, PTE_W | PTE_U);
8010432d:	6a 06                	push   $0x6
8010432f:	ff 75 0c             	push   0xc(%ebp)
80104332:	56                   	push   %esi
80104333:	ff 73 04             	push   0x4(%ebx)
80104336:	e8 f5 30 00 00       	call   80107430 <map_pages>
    if(addrfound <= 0) {
8010433b:	83 c4 10             	add    $0x10,%esp
8010433e:	85 c0                	test   %eax,%eax
80104340:	75 ca                	jne    8010430c <mmap+0x5c>
80104342:	eb c3                	jmp    80104307 <mmap+0x57>
...
8010435a:	68 04 7c 10 80       	push   $0x80107c04
...
8010439f:	e8 ac 02 00 00       	call   80104650 <acquire>
  while (lk->locked) {
...
801043b5:	e8 96 fc ff ff       	call   80104050 <sleep>
  while (lk->locked) {
...
801043c3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801043c9:	e8 b2 f5 ff ff       	call   80103980 <myproc>
...
801043dc:	5d                   	pop    %ebp
  release(&lk->lk);
801043dd:	e9 0e 02 00 00       	jmp    801045f0 <release>
...
801043ff:	e8 4c 02 00 00       	call   80104650 <acquire>
  lk->locked = 0;
...
80104414:	e8 f7 fc ff ff       	call   80104110 <wakeup>
  release(&lk->lk);
...
80104424:	5d                   	pop    %ebp
  release(&lk->lk);
80104425:	e9 c6 01 00 00       	jmp    801045f0 <release>
...
80104442:	e8 09 02 00 00       	call   80104650 <acquire>
...
80104454:	e8 97 01 00 00       	call   801045f0 <release>
  return r;
}
...
8010446b:	e8 10 f5 ff ff       	call   80103980 <myproc>
...
801044c7:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801044c9:	83 fa 0a             	cmp    $0xa,%edx
...
801044d7:	90                   	nop
  for(; i < 10; i++)
801044d8:	8d 04 91             	lea    (%ecx,%edx,4),%eax
...
80104509:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010450a:	e8 f1 f3 ff ff       	call   80103900 <mycpu>
8010450f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104515:	85 c0                	test   %eax,%eax
80104517:	74 17                	je     80104530 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104519:	e8 e2 f3 ff ff       	call   80103900 <mycpu>
8010451e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
8010452a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104530:	e8 cb f3 ff ff       	call   80103900 <mycpu>
80104535:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010453b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80104541:	eb d6                	jmp    80104519 <pushcli+0x19>
...
8010457c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104580:	e8 7b f3 ff ff       	call   80103900 <mycpu>
...
80104595:	68 0f 7c 10 80       	push   $0x80107c0f
8010459a:	e8 e1 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010459f:	83 ec 0c             	sub    $0xc,%esp
801045a2:	68 26 7c 10 80       	push   $0x80107c26
801045a7:	e8 d4 bd ff ff       	call   80100380 <panic>
...
801045c3:	75 0b                	jne    801045d0 <holding+0x20>
  popcli();
801045c5:	e8 86 ff ff ff       	call   80104550 <popcli>
}
...
801045d3:	e8 28 f3 ff ff       	call   80103900 <mycpu>
801045d8:	39 c3                	cmp    %eax,%ebx
801045da:	0f 94 c3             	sete   %bl
  popcli();
801045dd:	e8 6e ff ff ff       	call   80104550 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801045e2:	0f b6 db             	movzbl %bl,%ebx
}
801045e5:	89 d8                	mov    %ebx,%eax
801045e7:	5b                   	pop    %ebx
801045e8:	5e                   	pop    %esi
801045e9:	5d                   	pop    %ebp
801045ea:	c3                   	ret    
...
801045f5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801045f8:	e8 03 ff ff ff       	call   80104500 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801045fd:	8b 03                	mov    (%ebx),%eax
801045ff:	85 c0                	test   %eax,%eax
80104601:	75 15                	jne    80104618 <release+0x28>
  popcli();
80104603:	e8 48 ff ff ff       	call   80104550 <popcli>
    panic("release");
80104608:	83 ec 0c             	sub    $0xc,%esp
8010460b:	68 2d 7c 10 80       	push   $0x80107c2d
80104610:	e8 6b bd ff ff       	call   80100380 <panic>
80104615:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104618:	8b 73 08             	mov    0x8(%ebx),%esi
8010461b:	e8 e0 f2 ff ff       	call   80103900 <mycpu>
80104620:	39 c6                	cmp    %eax,%esi
80104622:	75 df                	jne    80104603 <release+0x13>
  popcli();
80104624:	e8 27 ff ff ff       	call   80104550 <popcli>
  lk->pcs[0] = 0;
80104629:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104630:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104637:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010463c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80104642:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104645:	5b                   	pop    %ebx
80104646:	5e                   	pop    %esi
80104647:	5d                   	pop    %ebp
  popcli();
80104648:	e9 03 ff ff ff       	jmp    80104550 <popcli>
...
80104657:	e8 a4 fe ff ff       	call   80104500 <pushcli>
  if(holding(lk))
8010465c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010465f:	e8 9c fe ff ff       	call   80104500 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104664:	8b 03                	mov    (%ebx),%eax
80104666:	85 c0                	test   %eax,%eax
80104668:	75 7e                	jne    801046e8 <acquire+0x98>
  popcli();
8010466a:	e8 e1 fe ff ff       	call   80104550 <popcli>
  asm volatile("lock; xchgl %0, %1" :
8010466f:	b9 01 00 00 00       	mov    $0x1,%ecx
80104674:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
80104678:	8b 55 08             	mov    0x8(%ebp),%edx
8010467b:	89 c8                	mov    %ecx,%eax
8010467d:	f0 87 02             	lock xchg %eax,(%edx)
80104680:	85 c0                	test   %eax,%eax
80104682:	75 f4                	jne    80104678 <acquire+0x28>
  __sync_synchronize();
80104684:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104689:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010468c:	e8 6f f2 ff ff       	call   80103900 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104691:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
80104694:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
80104696:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
...
801046ac:	77 1a                	ja     801046c8 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
801046ae:	8b 5a 04             	mov    0x4(%edx),%ebx
801046b1:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
801046b5:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
801046b8:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
801046ba:	83 f8 0a             	cmp    $0xa,%eax
801046bd:	75 e1                	jne    801046a0 <acquire+0x50>
}
801046bf:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801046c2:	c9                   	leave  
801046c3:	c3                   	ret    
801046c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
801046c8:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
801046cc:	8d 51 34             	lea    0x34(%ecx),%edx
801046cf:	90                   	nop
    pcs[i] = 0;
...
801046db:	75 f3                	jne    801046d0 <acquire+0x80>
}
...
801046e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801046e8:	8b 5b 08             	mov    0x8(%ebx),%ebx
801046eb:	e8 10 f2 ff ff       	call   80103900 <mycpu>
801046f0:	39 c3                	cmp    %eax,%ebx
801046f2:	0f 85 72 ff ff ff    	jne    8010466a <acquire+0x1a>
  popcli();
801046f8:	e8 53 fe ff ff       	call   80104550 <popcli>
    panic("acquire");
801046fd:	83 ec 0c             	sub    $0xc,%esp
80104700:	68 35 7c 10 80       	push   $0x80107c35
...
80104947:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010494a:	e8 31 f0 ff ff       	call   80103980 <myproc>
...
801049d5:	e8 a6 ef ff ff       	call   80103980 <myproc>
...
801049e3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049e6:	e8 95 ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a26:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104a29:	e8 52 ef ff ff       	call   80103980 <myproc>
80104a2e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a30:	e8 4b ef ff ff       	call   80103980 <myproc>
...
80104a3e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a41:	e8 3a ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a94:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a95:	e8 e6 ee ff ff       	call   80103980 <myproc>
...
80104aa3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104aa6:	e8 d5 ee ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b14:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b17:	e8 64 ee ff ff       	call   80103980 <myproc>
...
80104b2c:	8b 14 85 60 7c 10 80 	mov    -0x7fef83a0(,%eax,4),%edx
...
80104b58:	68 3d 7c 10 80       	push   $0x80107c3d
...
80104b97:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104b9a:	e8 21 d5 ff ff       	call   801020c0 <nameiparent>
...
80104bbc:	e8 1f d1 ff ff       	call   80101ce0 <dirlookup>
...
80104bce:	e8 3d ce ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104bd3:	89 34 24             	mov    %esi,(%esp)
80104bd6:	e8 a5 cb ff ff       	call   80101780 <ilock>
...
80104c04:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104c06:	e8 05 ce ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104c2a:	e8 e1 c9 ff ff       	call   80101610 <ialloc>
...
80104c40:	e8 3b cb ff ff       	call   80101780 <ilock>
  ip->major = major;
...
80104c61:	e8 6a ca ff ff       	call   801016d0 <iupdate>
...
80104c78:	e8 63 d3 ff ff       	call   80101fe0 <dirlink>
...
80104c88:	e8 83 cd ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104ca9:	e8 22 ca ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104cae:	83 c4 0c             	add    $0xc,%esp
80104cb1:	ff 76 04             	push   0x4(%esi)
80104cb4:	68 dc 7c 10 80       	push   $0x80107cdc
80104cb9:	56                   	push   %esi
80104cba:	e8 21 d3 ff ff       	call   80101fe0 <dirlink>
...
80104ccc:	68 db 7c 10 80       	push   $0x80107cdb
80104cd1:	56                   	push   %esi
80104cd2:	e8 09 d3 ff ff       	call   80101fe0 <dirlink>
...
80104ce1:	68 cf 7c 10 80       	push   $0x80107ccf
...
80104cff:	68 de 7c 10 80       	push   $0x80107cde
80104d04:	e8 77 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d09:	83 ec 0c             	sub    $0xc,%esp
80104d0c:	68 c0 7c 10 80       	push   $0x80107cc0
...
80104d4e:	74 20                	je     80104d70 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104d50:	e8 2b ec ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104ec0:	e8 bb ea ff ff       	call   80103980 <myproc>
...
80104ed1:	74 25                	je     80104ef8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104ed3:	e8 a8 ea ff ff       	call   80103980 <myproc>
  fileclose(f);
...
80104fa2:	0f 88 e2 00 00 00    	js     8010508a <sys_link+0x11a>
  begin_op();
80104fa8:	e8 b3 dd ff ff       	call   80102d60 <begin_op>
  if((ip = namei(old)) == 0){
80104fad:	83 ec 0c             	sub    $0xc,%esp
80104fb0:	ff 75 d4             	push   -0x2c(%ebp)
80104fb3:	e8 e8 d0 ff ff       	call   801020a0 <namei>
...
80104fc9:	e8 b2 c7 ff ff       	call   80101780 <ilock>
  if(ip->type == T_DIR){
...
80104fe8:	e8 e3 c6 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
80104fed:	89 1c 24             	mov    %ebx,(%esp)
80104ff0:	e8 6b c8 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104ff5:	58                   	pop    %eax
80104ff6:	5a                   	pop    %edx
80104ff7:	57                   	push   %edi
80104ff8:	ff 75 d0             	push   -0x30(%ebp)
80104ffb:	e8 c0 d0 ff ff       	call   801020c0 <nameiparent>
...
8010500d:	e8 6e c7 ff ff       	call   80101780 <ilock>
...
80105023:	e8 b8 cf ff ff       	call   80101fe0 <dirlink>
...
80105033:	e8 d8 c9 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
80105038:	89 1c 24             	mov    %ebx,(%esp)
8010503b:	e8 70 c8 ff ff       	call   801018b0 <iput>
  end_op();
80105040:	e8 8b dd ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010505c:	e8 af c9 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
80105075:	e8 56 c6 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010507a:	89 1c 24             	mov    %ebx,(%esp)
8010507d:	e8 8e c9 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105082:	e8 49 dd ff ff       	call   80102dd0 <end_op>
  return -1;
...
80105095:	e8 76 c9 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010509a:	e8 31 dd ff ff       	call   80102dd0 <end_op>
    return -1;
8010509f:	83 c4 10             	add    $0x10,%esp
801050a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050a7:	eb a1                	jmp    8010504a <sys_link+0xda>
    end_op();
801050a9:	e8 22 dd ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105108:	e8 73 c6 ff ff       	call   80101780 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010510d:	58                   	pop    %eax
8010510e:	5a                   	pop    %edx
8010510f:	68 dc 7c 10 80       	push   $0x80107cdc
80105114:	53                   	push   %ebx
80105115:	e8 a6 cb ff ff       	call   80101cc0 <namecmp>
...
80105128:	68 db 7c 10 80       	push   $0x80107cdb
8010512d:	53                   	push   %ebx
8010512e:	e8 8d cb ff ff       	call   80101cc0 <namecmp>
...
80105147:	e8 94 cb ff ff       	call   80101ce0 <dirlookup>
...
80105190:	e8 fb c9 ff ff       	call   80101b90 <writei>
...
801051b2:	e8 59 c8 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
801051b7:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801051bc:	89 1c 24             	mov    %ebx,(%esp)
801051bf:	e8 0c c5 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
801051c4:	89 1c 24             	mov    %ebx,(%esp)
801051c7:	e8 44 c8 ff ff       	call   80101a10 <iunlockput>
  end_op();
...
801051fd:	e8 8e c8 ff ff       	call   80101a90 <readi>
...
80105226:	e8 e5 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010522b:	e8 a0 db ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010524c:	e8 7f c4 ff ff       	call   801016d0 <iupdate>
...
8010525e:	e9 73 ff ff ff       	jmp    801051d6 <sys_unlink+0x116>
    end_op();
80105263:	e8 68 db ff ff       	call   80102dd0 <end_op>
    return -1;
...
801052d2:	78 79                	js     8010534d <sys_open+0xad>
  ...
  begin_op();
801052d4:	e8 87 da ff ff       	call   80102d60 <begin_op>
...
801052e5:	e8 b6 cd ff ff       	call   801020a0 <namei>
...
801052fb:	e8 80 c4 ff ff       	call   80101780 <ilock>
...
80105317:	74 23                	je     8010533c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105319:	e8 62 e6 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105340:	e8 cb c6 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
80105390:	e8 cb c4 ff ff       	call   80101860 <iunlock>
  end_op();
80105395:	e8 36 da ff ff       	call   80102dd0 <end_op>
...
8010541f:	e8 ec c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105424:	e8 a7 d9 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801054ae:	e8 5d c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
801054b3:	e8 18 d9 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801054d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054d8:	e8 a3 e4 ff ff       	call   80103980 <myproc>
801054dd:	89 c6                	mov    %eax,%esi
  
  begin_op();
801054df:	e8 7c d8 ff ff       	call   80102d60 <begin_op>
...
801054ff:	e8 9c cb ff ff       	call   801020a0 <namei>
...
80105511:	e8 6a c2 ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
80105524:	e8 37 c3 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105529:	58                   	pop    %eax
8010552a:	ff 76 68             	push   0x68(%esi)
8010552d:	e8 7e c3 ff ff       	call   801018b0 <iput>
  end_op();
...
80105554:	e8 b7 c4 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
80105698:	e8 93 dd ff ff       	call   80103430 <pipealloc>
...
801056a7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056a9:	e8 d2 e2 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
80105740:	e9 db e3 ff ff       	jmp    80103b20 <fork>
...
80105753:	83 ec 08             	sub    $0x8,%esp
  exit();
80105756:	e8 45 e6 ff ff       	call   80103da0 <exit>
...
{
  return wait();
80105760:	e9 6b e7 ff ff       	jmp    80103ed0 <wait>
...
8010577c:	e8 4f f2 ff ff       	call   801049d0 <argint>
...
801057b3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057b6:	e8 c5 e1 ff ff       	call   80103980 <myproc>
...
801057e6:	e8 b5 e2 ff ff       	call   80103aa0 <growproc>
...
8010581d:	e8 ae f1 ff ff       	call   801049d0 <argint>
...
80105830:	68 80 dc 11 80       	push   $0x8011dc80
80105835:	e8 16 ee ff ff       	call   80104650 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010583a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010583d:	8b 1d 60 dc 11 80    	mov    0x8011dc60,%ebx
  while(ticks - ticks0 < n){
...
80105853:	68 80 dc 11 80       	push   $0x8011dc80
80105858:	68 60 dc 11 80       	push   $0x8011dc60
8010585d:	e8 ee e7 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
80105862:	a1 60 dc 11 80       	mov    0x8011dc60,%eax
...
80105880:	68 80 dc 11 80       	push   $0x8011dc80
80105885:	e8 66 ed ff ff       	call   801045f0 <release>
  }
  release(&tickslock);
  return 0;
}
...
801058a3:	68 80 dc 11 80       	push   $0x8011dc80
801058a8:	e8 43 ed ff ff       	call   801045f0 <release>
  return 0;
...
801058c4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058c7:	68 80 dc 11 80       	push   $0x8011dc80
801058cc:	e8 7f ed ff ff       	call   80104650 <acquire>
  xticks = ticks;
801058d1:	8b 1d 60 dc 11 80    	mov    0x8011dc60,%ebx
  release(&tickslock);
801058d7:	c7 04 24 80 dc 11 80 	movl   $0x8011dc80,(%esp)
801058de:	e8 0d ed ff ff       	call   801045f0 <release>
  return xticks;
}
...
void* sys_mmap(void) {
801058f7:	83 ec 2c             	sub    $0x2c,%esp
  if(argint(0, &addr) < 0)
801058fa:	50                   	push   %eax
801058fb:	6a 00                	push   $0x0
801058fd:	e8 ce f0 ff ff       	call   801049d0 <argint>
80105902:	83 c4 10             	add    $0x10,%esp
80105905:	85 c0                	test   %eax,%eax
80105907:	0f 88 f3 00 00 00    	js     80105a00 <sys_mmap+0x110>
    return (void*)-1;
...
80105916:	e8 b5 f0 ff ff       	call   801049d0 <argint>
8010591b:	83 c4 10             	add    $0x10,%esp
8010591e:	85 c0                	test   %eax,%eax
80105920:	0f 88 da 00 00 00    	js     80105a00 <sys_mmap+0x110>
    return (void*)-1;
  if(argint(2, &prot) < 0)
80105926:	83 ec 08             	sub    $0x8,%esp
80105929:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010592c:	50                   	push   %eax
8010592d:	6a 02                	push   $0x2
8010592f:	e8 9c f0 ff ff       	call   801049d0 <argint>
80105934:	83 c4 10             	add    $0x10,%esp
80105937:	85 c0                	test   %eax,%eax
80105939:	0f 88 c1 00 00 00    	js     80105a00 <sys_mmap+0x110>
    return (void*)-1;
  if(argint(3, &flags) < 0)
8010593f:	83 ec 08             	sub    $0x8,%esp
80105942:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105945:	50                   	push   %eax
80105946:	6a 03                	push   $0x3
80105948:	e8 83 f0 ff ff       	call   801049d0 <argint>
8010594d:	83 c4 10             	add    $0x10,%esp
80105950:	85 c0                	test   %eax,%eax
80105952:	0f 88 a8 00 00 00    	js     80105a00 <sys_mmap+0x110>
    return (void*)-1;
  if(argint(4, &fd) < 0)
80105958:	83 ec 08             	sub    $0x8,%esp
8010595b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010595e:	50                   	push   %eax
8010595f:	6a 04                	push   $0x4
80105961:	e8 6a f0 ff ff       	call   801049d0 <argint>
80105966:	83 c4 10             	add    $0x10,%esp
80105969:	85 c0                	test   %eax,%eax
8010596b:	0f 88 8f 00 00 00    	js     80105a00 <sys_mmap+0x110>
    return (void*)-1;
  if(argint(5, &offset) < 0)
80105971:	83 ec 08             	sub    $0x8,%esp
80105974:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105977:	50                   	push   %eax
80105978:	6a 05                	push   $0x5
8010597a:	e8 51 f0 ff ff       	call   801049d0 <argint>
8010597f:	83 c4 10             	add    $0x10,%esp
80105982:	85 c0                	test   %eax,%eax
80105984:	78 7a                	js     80105a00 <sys_mmap+0x110>
    return (void*)-1;
...
8010598f:	ff 75 ec             	push   -0x14(%ebp)
80105992:	ff 75 e8             	push   -0x18(%ebp)
80105995:	ff 75 e4             	push   -0x1c(%ebp)
80105998:	ff 75 e0             	push   -0x20(%ebp)
8010599b:	e8 10 e9 ff ff       	call   801042b0 <mmap>
  if(addrmap == (void*)-1)
801059a0:	83 c4 20             	add    $0x20,%esp
  addrmap = (void *)mmap((void*)addr, length, prot, flags, fd, offset);
801059a3:	89 c3                	mov    %eax,%ebx
  if(addrmap == (void*)-1)
801059a5:	83 f8 ff             	cmp    $0xffffffff,%eax
801059a8:	74 56                	je     80105a00 <sys_mmap+0x110>
    return (void*)-1;
  int i = 0;
  struct proc* current = myproc();
801059aa:	e8 d1 df ff ff       	call   80103980 <myproc>
  while(current->maparray[i].len != 0) {
801059af:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
801059b5:	85 c9                	test   %ecx,%ecx
801059b7:	74 1b                	je     801059d4 <sys_mmap+0xe4>
801059b9:	8d 90 94 00 00 00    	lea    0x94(%eax),%edx
  int i = 0;
801059bf:	31 c9                	xor    %ecx,%ecx
801059c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  while(current->maparray[i].len != 0) {
801059c8:	83 c2 14             	add    $0x14,%edx
    i++;
801059cb:	83 c1 01             	add    $0x1,%ecx
  while(current->maparray[i].len != 0) {
801059ce:	83 7a ec 00          	cmpl   $0x0,-0x14(%edx)
801059d2:	75 f4                	jne    801059c8 <sys_mmap+0xd8>
  }
  current->maparray[i].addr = addrmap;
801059d4:	8d 14 89             	lea    (%ecx,%ecx,4),%edx
801059d7:	8d 04 90             	lea    (%eax,%edx,4),%eax
  current->maparray[i].flag = flags;
801059da:	8b 55 ec             	mov    -0x14(%ebp),%edx
  current->maparray[i].addr = addrmap;
801059dd:	89 58 7c             	mov    %ebx,0x7c(%eax)
  current->maparray[i].flag = flags;
801059e0:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)
  current->maparray[i].len = length;
801059e6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801059e9:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  current->maparray[i].prot = prot;
801059ef:	8b 55 e8             	mov    -0x18(%ebp),%edx
801059f2:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)

  // implementation in proc.c
  return addrmap;
801059f8:	eb 0b                	jmp    80105a05 <sys_mmap+0x115>
801059fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return (void*)-1;
80105a00:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
80105a05:	89 d8                	mov    %ebx,%eax
80105a07:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105a0a:	c9                   	leave  
80105a0b:	c3                   	ret    
...
80105a14:	83 ec 14             	sub    $0x14,%esp
  ...
  struct proc* current = myproc();
80105a17:	e8 64 df ff ff       	call   80103980 <myproc>
...
80105a27:	e8 a4 ef ff ff       	call   801049d0 <argint>
80105a2c:	83 c4 10             	add    $0x10,%esp
80105a2f:	85 c0                	test   %eax,%eax
80105a31:	0f 88 85 00 00 00    	js     80105abc <sys_munmap+0xac>
    return -1;
  if(argint(1, &length) < 0)
...
80105a40:	e8 8b ef ff ff       	call   801049d0 <argint>
80105a45:	83 c4 10             	add    $0x10,%esp
80105a48:	85 c0                	test   %eax,%eax
80105a4a:	78 70                	js     80105abc <sys_munmap+0xac>
    return -1;
...
80105a4f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a52:	83 ec 04             	sub    $0x4,%esp
  length = PGROUNDUP(length);
80105a55:	05 ff 0f 00 00       	add    $0xfff,%eax
  if(deallocuvm(current->pgdir, (uint)addr + length, (uint)addr) == 0){
80105a5a:	52                   	push   %edx
  length = PGROUNDUP(length);
80105a5b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80105a60:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(deallocuvm(current->pgdir, (uint)addr + length, (uint)addr) == 0){
80105a63:	01 d0                	add    %edx,%eax
80105a65:	50                   	push   %eax
80105a66:	ff 73 04             	push   0x4(%ebx)
80105a69:	e8 d2 15 00 00       	call   80107040 <deallocuvm>
80105a6e:	83 c4 10             	add    $0x10,%esp
80105a71:	85 c0                	test   %eax,%eax
80105a73:	74 47                	je     80105abc <sys_munmap+0xac>
    return -1;
  }

  for(int i = 0; i<= 31; i++) {
    if (current->maparray[i].addr == (void*) addr) {
80105a75:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105a78:	8d 43 7c             	lea    0x7c(%ebx),%eax
80105a7b:	8d 93 fc 02 00 00    	lea    0x2fc(%ebx),%edx
80105a81:	eb 0c                	jmp    80105a8f <sys_munmap+0x7f>
80105a83:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105a87:	90                   	nop
  for(int i = 0; i<= 31; i++) {
80105a88:	83 c0 14             	add    $0x14,%eax
80105a8b:	39 d0                	cmp    %edx,%eax
80105a8d:	74 26                	je     80105ab5 <sys_munmap+0xa5>
    if (current->maparray[i].addr == (void*) addr) {
80105a8f:	39 08                	cmp    %ecx,(%eax)
80105a91:	75 f5                	jne    80105a88 <sys_munmap+0x78>
      current->maparray[i].addr = 0;
80105a93:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(int i = 0; i<= 31; i++) {
80105a99:	83 c0 14             	add    $0x14,%eax
      current->maparray[i].flag = 0;
80105a9c:	c7 40 f4 00 00 00 00 	movl   $0x0,-0xc(%eax)
      current->maparray[i].prot = 0;
80105aa3:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
      current->maparray[i].len = 0;
80105aaa:	c7 40 f0 00 00 00 00 	movl   $0x0,-0x10(%eax)
  for(int i = 0; i<= 31; i++) {
80105ab1:	39 d0                	cmp    %edx,%eax
80105ab3:	75 da                	jne    80105a8f <sys_munmap+0x7f>
...
80105ac1:	eb f4                	jmp    80105ab7 <sys_munmap+0xa7>
...
80105b07:	c7 04 c5 c2 dc 11 80 	movl   $0x8e000008,-0x7fee233e(,%eax,8)
80105b0e:	08 00 00 8e 
80105b12:	66 89 14 c5 c0 dc 11 	mov    %dx,-0x7fee2340(,%eax,8)
80105b19:	80 
80105b1a:	c1 ea 10             	shr    $0x10,%edx
80105b1d:	66 89 14 c5 c6 dc 11 	mov    %dx,-0x7fee233a(,%eax,8)
80105b24:	80 
  for(i = 0; i < 256; i++)
...
80105b37:	c7 05 c2 de 11 80 08 	movl   $0xef000008,0x8011dec2
80105b3e:	00 00 ef 
  initlock(&tickslock, "time");
80105b41:	68 21 7d 10 80       	push   $0x80107d21
80105b46:	68 80 dc 11 80       	push   $0x8011dc80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b4b:	66 a3 c0 de 11 80    	mov    %ax,0x8011dec0
80105b51:	c1 e8 10             	shr    $0x10,%eax
80105b54:	66 a3 c6 de 11 80    	mov    %ax,0x8011dec6
  initlock(&tickslock, "time");
80105b5a:	e8 21 e9 ff ff       	call   80104480 <initlock>
}
...
80105b7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b7f:	b8 c0 dc 11 80       	mov    $0x8011dcc0,%eax
...
80105bb2:	0f 84 50 01 00 00    	je     80105d08 <trap+0x168>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105bb8:	83 e8 0e             	sub    $0xe,%eax
80105bbb:	83 f8 31             	cmp    $0x31,%eax
80105bbe:	0f 87 a4 00 00 00    	ja     80105c68 <trap+0xc8>
80105bc4:	ff 24 85 e8 7d 10 80 	jmp    *-0x7fef8218(,%eax,4)
...
80105bd7:	0f 84 13 02 00 00    	je     80105df0 <trap+0x250>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105bdd:	e8 2e cd ff ff       	call   80102910 <lapiceoi>
  }
...
80105be2:	e8 99 dd ff ff       	call   80103980 <myproc>
80105be7:	85 c0                	test   %eax,%eax
80105be9:	74 1d                	je     80105c08 <trap+0x68>
80105beb:	e8 90 dd ff ff       	call   80103980 <myproc>
80105bf0:	8b 50 24             	mov    0x24(%eax),%edx
80105bf3:	85 d2                	test   %edx,%edx
80105bf5:	74 11                	je     80105c08 <trap+0x68>
80105bf7:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105bfb:	83 e0 03             	and    $0x3,%eax
80105bfe:	66 83 f8 03          	cmp    $0x3,%ax
80105c02:	0f 84 c8 01 00 00    	je     80105dd0 <trap+0x230>
    exit();
...
80105c0f:	74 0f                	je     80105c20 <trap+0x80>
80105c11:	e8 6a dd ff ff       	call   80103980 <myproc>
80105c16:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105c1a:	0f 84 d0 00 00 00    	je     80105cf0 <trap+0x150>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c20:	e8 5b dd ff ff       	call   80103980 <myproc>
80105c25:	85 c0                	test   %eax,%eax
80105c27:	74 1d                	je     80105c46 <trap+0xa6>
80105c29:	e8 52 dd ff ff       	call   80103980 <myproc>
80105c2e:	8b 40 24             	mov    0x24(%eax),%eax
80105c31:	85 c0                	test   %eax,%eax
80105c33:	74 11                	je     80105c46 <trap+0xa6>
80105c35:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c39:	83 e0 03             	and    $0x3,%eax
80105c3c:	66 83 f8 03          	cmp    $0x3,%ax
80105c40:	0f 84 ef 00 00 00    	je     80105d35 <trap+0x195>
    exit();
}
80105c46:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105c49:	5b                   	pop    %ebx
80105c4a:	5e                   	pop    %esi
80105c4b:	5f                   	pop    %edi
80105c4c:	5d                   	pop    %ebp
...
80105c50:	0f 20 d0             	mov    %cr2,%eax
    cprintf("\tPagefault at virtual addr %x\n", rcr2());
80105c53:	83 ec 08             	sub    $0x8,%esp
80105c56:	50                   	push   %eax
80105c57:	68 50 7d 10 80       	push   $0x80107d50
80105c5c:	e8 3f aa ff ff       	call   801006a0 <cprintf>
80105c61:	83 c4 10             	add    $0x10,%esp
80105c64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc() == 0 || (tf->cs&3) == 0){
80105c68:	e8 13 dd ff ff       	call   80103980 <myproc>
80105c6d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c70:	85 c0                	test   %eax,%eax
80105c72:	0f 84 ac 01 00 00    	je     80105e24 <trap+0x284>
80105c78:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105c7c:	0f 84 a2 01 00 00    	je     80105e24 <trap+0x284>
80105c82:	0f 20 d1             	mov    %cr2,%ecx
80105c85:	89 4d d8             	mov    %ecx,-0x28(%ebp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c88:	e8 d3 dc ff ff       	call   80103960 <cpuid>
80105c8d:	8b 73 30             	mov    0x30(%ebx),%esi
80105c90:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105c93:	8b 43 34             	mov    0x34(%ebx),%eax
80105c96:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80105c99:	e8 e2 dc ff ff       	call   80103980 <myproc>
80105c9e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105ca1:	e8 da dc ff ff       	call   80103980 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ca6:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105ca9:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105cac:	51                   	push   %ecx
80105cad:	57                   	push   %edi
80105cae:	52                   	push   %edx
80105caf:	ff 75 e4             	push   -0x1c(%ebp)
80105cb2:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105cb3:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105cb6:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105cb9:	56                   	push   %esi
80105cba:	ff 70 10             	push   0x10(%eax)
80105cbd:	68 a4 7d 10 80       	push   $0x80107da4
80105cc2:	e8 d9 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105cc7:	83 c4 20             	add    $0x20,%esp
80105cca:	e8 b1 dc ff ff       	call   80103980 <myproc>
80105ccf:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cd6:	e8 a5 dc ff ff       	call   80103980 <myproc>
80105cdb:	85 c0                	test   %eax,%eax
80105cdd:	0f 85 08 ff ff ff    	jne    80105beb <trap+0x4b>
80105ce3:	e9 20 ff ff ff       	jmp    80105c08 <trap+0x68>
80105ce8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105cef:	90                   	nop
  if(myproc() && myproc()->state == RUNNING &&
80105cf0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105cf4:	0f 85 26 ff ff ff    	jne    80105c20 <trap+0x80>
    yield();
80105cfa:	e8 01 e3 ff ff       	call   80104000 <yield>
80105cff:	e9 1c ff ff ff       	jmp    80105c20 <trap+0x80>
...
80105d12:	0f 85 c8 00 00 00    	jne    80105de0 <trap+0x240>
    myproc()->tf = tf;
80105d18:	e8 63 dc ff ff       	call   80103980 <myproc>
80105d1d:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d20:	e8 eb ed ff ff       	call   80104b10 <syscall>
    if(myproc()->killed)
80105d25:	e8 56 dc ff ff       	call   80103980 <myproc>
80105d2a:	8b 48 24             	mov    0x24(%eax),%ecx
80105d2d:	85 c9                	test   %ecx,%ecx
80105d2f:	0f 84 11 ff ff ff    	je     80105c46 <trap+0xa6>
}
...
80105d3b:	5d                   	pop    %ebp
      exit();
80105d3c:	e9 5f e0 ff ff       	jmp    80103da0 <exit>
80105d41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105d48:	8b 7b 38             	mov    0x38(%ebx),%edi
80105d4b:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105d4f:	e8 0c dc ff ff       	call   80103960 <cpuid>
80105d54:	57                   	push   %edi
80105d55:	56                   	push   %esi
80105d56:	50                   	push   %eax
80105d57:	68 2c 7d 10 80       	push   $0x80107d2c
80105d5c:	e8 3f a9 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105d61:	e8 aa cb ff ff       	call   80102910 <lapiceoi>
    break;
80105d66:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d69:	e8 12 dc ff ff       	call   80103980 <myproc>
80105d6e:	85 c0                	test   %eax,%eax
80105d70:	0f 85 75 fe ff ff    	jne    80105beb <trap+0x4b>
80105d76:	e9 8d fe ff ff       	jmp    80105c08 <trap+0x68>
80105d7b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105d7f:	90                   	nop
    kbdintr();
80105d80:	e8 4b ca ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105d85:	e8 86 cb ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d8a:	e8 f1 db ff ff       	call   80103980 <myproc>
80105d8f:	85 c0                	test   %eax,%eax
80105d91:	0f 85 54 fe ff ff    	jne    80105beb <trap+0x4b>
80105d97:	e9 6c fe ff ff       	jmp    80105c08 <trap+0x68>
80105d9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105da0:	e8 1b 02 00 00       	call   80105fc0 <uartintr>
    lapiceoi();
80105da5:	e8 66 cb ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105daa:	e8 d1 db ff ff       	call   80103980 <myproc>
80105daf:	85 c0                	test   %eax,%eax
80105db1:	0f 85 34 fe ff ff    	jne    80105beb <trap+0x4b>
80105db7:	e9 4c fe ff ff       	jmp    80105c08 <trap+0x68>
80105dbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105dc0:	e8 7b c4 ff ff       	call   80102240 <ideintr>
80105dc5:	e9 13 fe ff ff       	jmp    80105bdd <trap+0x3d>
80105dca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105dd0:	e8 cb df ff ff       	call   80103da0 <exit>
80105dd5:	e9 2e fe ff ff       	jmp    80105c08 <trap+0x68>
80105dda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105de0:	e8 bb df ff ff       	call   80103da0 <exit>
80105de5:	e9 2e ff ff ff       	jmp    80105d18 <trap+0x178>
80105dea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105df0:	83 ec 0c             	sub    $0xc,%esp
80105df3:	68 80 dc 11 80       	push   $0x8011dc80
80105df8:	e8 53 e8 ff ff       	call   80104650 <acquire>
      wakeup(&ticks);
80105dfd:	c7 04 24 60 dc 11 80 	movl   $0x8011dc60,(%esp)
      ticks++;
80105e04:	83 05 60 dc 11 80 01 	addl   $0x1,0x8011dc60
      wakeup(&ticks);
80105e0b:	e8 00 e3 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105e10:	c7 04 24 80 dc 11 80 	movl   $0x8011dc80,(%esp)
80105e17:	e8 d4 e7 ff ff       	call   801045f0 <release>
80105e1c:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105e1f:	e9 b9 fd ff ff       	jmp    80105bdd <trap+0x3d>
80105e24:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105e27:	e8 34 db ff ff       	call   80103960 <cpuid>
80105e2c:	83 ec 0c             	sub    $0xc,%esp
80105e2f:	56                   	push   %esi
80105e30:	57                   	push   %edi
80105e31:	50                   	push   %eax
80105e32:	ff 73 30             	push   0x30(%ebx)
80105e35:	68 70 7d 10 80       	push   $0x80107d70
80105e3a:	e8 61 a8 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105e3f:	83 c4 14             	add    $0x14,%esp
80105e42:	68 26 7d 10 80       	push   $0x80107d26
80105e47:	e8 34 a5 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80105e50:	a1 c0 e4 11 80       	mov    0x8011e4c0,%eax
...
80105ed7:	74 78                	je     80105f51 <uartinit+0xd1>
  uart = 1;
80105ed9:	c7 05 c0 e4 11 80 01 	movl   $0x1,0x8011e4c0
80105ee0:	00 00 00 
80105ee3:	89 fa                	mov    %edi,%edx
...
80105eec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105eef:	bf b0 7e 10 80       	mov    $0x80107eb0,%edi
80105ef4:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105ef9:	6a 00                	push   $0x0
80105efb:	6a 04                	push   $0x4
80105efd:	e8 7e c5 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105f02:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80105f06:	83 c4 10             	add    $0x10,%esp
80105f09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105f10:	a1 c0 e4 11 80       	mov    0x8011e4c0,%eax
80105f15:	bb 80 00 00 00       	mov    $0x80,%ebx
80105f1a:	85 c0                	test   %eax,%eax
80105f1c:	75 14                	jne    80105f32 <uartinit+0xb2>
80105f1e:	eb 23                	jmp    80105f43 <uartinit+0xc3>
    microdelay(10);
80105f20:	83 ec 0c             	sub    $0xc,%esp
80105f23:	6a 0a                	push   $0xa
80105f25:	e8 06 ca ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105f2a:	83 c4 10             	add    $0x10,%esp
80105f2d:	83 eb 01             	sub    $0x1,%ebx
80105f30:	74 07                	je     80105f39 <uartinit+0xb9>
80105f32:	89 f2                	mov    %esi,%edx
80105f34:	ec                   	in     (%dx),%al
80105f35:	a8 20                	test   $0x20,%al
80105f37:	74 e7                	je     80105f20 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105f39:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105f3d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105f42:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105f43:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105f47:	83 c7 01             	add    $0x1,%edi
80105f4a:	88 45 e7             	mov    %al,-0x19(%ebp)
80105f4d:	84 c0                	test   %al,%al
80105f4f:	75 bf                	jne    80105f10 <uartinit+0x90>
}
...
80105f60 <uartputc>:
  if(!uart)
80105f60:	a1 c0 e4 11 80       	mov    0x8011e4c0,%eax
80105f65:	85 c0                	test   %eax,%eax
80105f67:	74 47                	je     80105fb0 <uartputc+0x50>
{
...
80105f73:	bb 80 00 00 00       	mov    $0x80,%ebx
80105f78:	eb 18                	jmp    80105f92 <uartputc+0x32>
...
80105f90:	74 07                	je     80105f99 <uartputc+0x39>
80105f92:	89 f2                	mov    %esi,%edx
80105f94:	ec                   	in     (%dx),%al
80105f95:	a8 20                	test   $0x20,%al
80105f97:	74 e7                	je     80105f80 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105f99:	8b 45 08             	mov    0x8(%ebp),%eax
80105f9c:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105fcb:	e8 b0 a8 ff ff       	call   80100880 <consoleintr>
}
...
80105fd7:	6a 00                	push   $0x0
  jmp alltraps
80105fd9:	e9 e5 fa ff ff       	jmp    80105ac3 <alltraps>
...
80105fe0:	6a 01                	push   $0x1
  jmp alltraps
80105fe2:	e9 dc fa ff ff       	jmp    80105ac3 <alltraps>
...
80105fe9:	6a 02                	push   $0x2
  jmp alltraps
80105feb:	e9 d3 fa ff ff       	jmp    80105ac3 <alltraps>
...
80105ff2:	6a 03                	push   $0x3
  jmp alltraps
80105ff4:	e9 ca fa ff ff       	jmp    80105ac3 <alltraps>
...
80105ffb:	6a 04                	push   $0x4
  jmp alltraps
80105ffd:	e9 c1 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106004:	6a 05                	push   $0x5
  jmp alltraps
80106006:	e9 b8 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010600d:	6a 06                	push   $0x6
  jmp alltraps
8010600f:	e9 af fa ff ff       	jmp    80105ac3 <alltraps>
...
80106016:	6a 07                	push   $0x7
  jmp alltraps
80106018:	e9 a6 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010601d:	6a 08                	push   $0x8
  jmp alltraps
8010601f:	e9 9f fa ff ff       	jmp    80105ac3 <alltraps>
...
80106026:	6a 09                	push   $0x9
  jmp alltraps
80106028:	e9 96 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010602d:	6a 0a                	push   $0xa
  jmp alltraps
8010602f:	e9 8f fa ff ff       	jmp    80105ac3 <alltraps>
...
80106034:	6a 0b                	push   $0xb
  jmp alltraps
80106036:	e9 88 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010603b:	6a 0c                	push   $0xc
  jmp alltraps
8010603d:	e9 81 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106042:	6a 0d                	push   $0xd
  jmp alltraps
80106044:	e9 7a fa ff ff       	jmp    80105ac3 <alltraps>
...
80106049:	6a 0e                	push   $0xe
  jmp alltraps
8010604b:	e9 73 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106052:	6a 0f                	push   $0xf
  jmp alltraps
80106054:	e9 6a fa ff ff       	jmp    80105ac3 <alltraps>
...
8010605b:	6a 10                	push   $0x10
  jmp alltraps
8010605d:	e9 61 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106062:	6a 11                	push   $0x11
  jmp alltraps
80106064:	e9 5a fa ff ff       	jmp    80105ac3 <alltraps>
...
8010606b:	6a 12                	push   $0x12
  jmp alltraps
8010606d:	e9 51 fa ff ff       	jmp    80105ac3 <alltraps>
...
80106074:	6a 13                	push   $0x13
  jmp alltraps
80106076:	e9 48 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010607d:	6a 14                	push   $0x14
  jmp alltraps
8010607f:	e9 3f fa ff ff       	jmp    80105ac3 <alltraps>
...
80106086:	6a 15                	push   $0x15
  jmp alltraps
80106088:	e9 36 fa ff ff       	jmp    80105ac3 <alltraps>
...
8010608f:	6a 16                	push   $0x16
  jmp alltraps
80106091:	e9 2d fa ff ff       	jmp    80105ac3 <alltraps>
...
80106098:	6a 17                	push   $0x17
  jmp alltraps
8010609a:	e9 24 fa ff ff       	jmp    80105ac3 <alltraps>
...
801060a1:	6a 18                	push   $0x18
  jmp alltraps
801060a3:	e9 1b fa ff ff       	jmp    80105ac3 <alltraps>
...
801060aa:	6a 19                	push   $0x19
  jmp alltraps
801060ac:	e9 12 fa ff ff       	jmp    80105ac3 <alltraps>
...
801060b3:	6a 1a                	push   $0x1a
  jmp alltraps
801060b5:	e9 09 fa ff ff       	jmp    80105ac3 <alltraps>
...
801060bc:	6a 1b                	push   $0x1b
  jmp alltraps
801060be:	e9 00 fa ff ff       	jmp    80105ac3 <alltraps>
...
801060c5:	6a 1c                	push   $0x1c
  jmp alltraps
801060c7:	e9 f7 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060ce:	6a 1d                	push   $0x1d
  jmp alltraps
801060d0:	e9 ee f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060d7:	6a 1e                	push   $0x1e
  jmp alltraps
801060d9:	e9 e5 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060e0:	6a 1f                	push   $0x1f
  jmp alltraps
801060e2:	e9 dc f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060e9:	6a 20                	push   $0x20
  jmp alltraps
801060eb:	e9 d3 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060f2:	6a 21                	push   $0x21
  jmp alltraps
801060f4:	e9 ca f9 ff ff       	jmp    80105ac3 <alltraps>
...
801060fb:	6a 22                	push   $0x22
  jmp alltraps
801060fd:	e9 c1 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106104:	6a 23                	push   $0x23
  jmp alltraps
80106106:	e9 b8 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010610d:	6a 24                	push   $0x24
  jmp alltraps
8010610f:	e9 af f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106116:	6a 25                	push   $0x25
  jmp alltraps
80106118:	e9 a6 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010611f:	6a 26                	push   $0x26
  jmp alltraps
80106121:	e9 9d f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106128:	6a 27                	push   $0x27
  jmp alltraps
8010612a:	e9 94 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106131:	6a 28                	push   $0x28
  jmp alltraps
80106133:	e9 8b f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010613a:	6a 29                	push   $0x29
  jmp alltraps
8010613c:	e9 82 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106143:	6a 2a                	push   $0x2a
  jmp alltraps
80106145:	e9 79 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010614c:	6a 2b                	push   $0x2b
  jmp alltraps
8010614e:	e9 70 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106155:	6a 2c                	push   $0x2c
  jmp alltraps
80106157:	e9 67 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010615e:	6a 2d                	push   $0x2d
  jmp alltraps
80106160:	e9 5e f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106167:	6a 2e                	push   $0x2e
  jmp alltraps
80106169:	e9 55 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106170:	6a 2f                	push   $0x2f
  jmp alltraps
80106172:	e9 4c f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106179:	6a 30                	push   $0x30
  jmp alltraps
8010617b:	e9 43 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106182:	6a 31                	push   $0x31
  jmp alltraps
80106184:	e9 3a f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010618b:	6a 32                	push   $0x32
  jmp alltraps
8010618d:	e9 31 f9 ff ff       	jmp    80105ac3 <alltraps>
...
80106194:	6a 33                	push   $0x33
  jmp alltraps
80106196:	e9 28 f9 ff ff       	jmp    80105ac3 <alltraps>
...
8010619d:	6a 34                	push   $0x34
  jmp alltraps
8010619f:	e9 1f f9 ff ff       	jmp    80105ac3 <alltraps>
...
801061a6:	6a 35                	push   $0x35
  jmp alltraps
801061a8:	e9 16 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801061af:	6a 36                	push   $0x36
  jmp alltraps
801061b1:	e9 0d f9 ff ff       	jmp    80105ac3 <alltraps>
...
801061b8:	6a 37                	push   $0x37
  jmp alltraps
801061ba:	e9 04 f9 ff ff       	jmp    80105ac3 <alltraps>
...
801061c1:	6a 38                	push   $0x38
  jmp alltraps
801061c3:	e9 fb f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061ca:	6a 39                	push   $0x39
  jmp alltraps
801061cc:	e9 f2 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061d3:	6a 3a                	push   $0x3a
  jmp alltraps
801061d5:	e9 e9 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061dc:	6a 3b                	push   $0x3b
  jmp alltraps
801061de:	e9 e0 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061e5:	6a 3c                	push   $0x3c
  jmp alltraps
801061e7:	e9 d7 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061ee:	6a 3d                	push   $0x3d
  jmp alltraps
801061f0:	e9 ce f8 ff ff       	jmp    80105ac3 <alltraps>
...
801061f7:	6a 3e                	push   $0x3e
  jmp alltraps
801061f9:	e9 c5 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106200:	6a 3f                	push   $0x3f
  jmp alltraps
80106202:	e9 bc f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106209:	6a 40                	push   $0x40
  jmp alltraps
8010620b:	e9 b3 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106212:	6a 41                	push   $0x41
  jmp alltraps
80106214:	e9 aa f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010621b:	6a 42                	push   $0x42
  jmp alltraps
8010621d:	e9 a1 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106224:	6a 43                	push   $0x43
  jmp alltraps
80106226:	e9 98 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010622d:	6a 44                	push   $0x44
  jmp alltraps
8010622f:	e9 8f f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106236:	6a 45                	push   $0x45
  jmp alltraps
80106238:	e9 86 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010623f:	6a 46                	push   $0x46
  jmp alltraps
80106241:	e9 7d f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106248:	6a 47                	push   $0x47
  jmp alltraps
8010624a:	e9 74 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106251:	6a 48                	push   $0x48
  jmp alltraps
80106253:	e9 6b f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010625a:	6a 49                	push   $0x49
  jmp alltraps
8010625c:	e9 62 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106263:	6a 4a                	push   $0x4a
  jmp alltraps
80106265:	e9 59 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010626c:	6a 4b                	push   $0x4b
  jmp alltraps
8010626e:	e9 50 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106275:	6a 4c                	push   $0x4c
  jmp alltraps
80106277:	e9 47 f8 ff ff       	jmp    80105ac3 <alltraps>
...
8010627e:	6a 4d                	push   $0x4d
  jmp alltraps
80106280:	e9 3e f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106287:	6a 4e                	push   $0x4e
  jmp alltraps
80106289:	e9 35 f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106290:	6a 4f                	push   $0x4f
  jmp alltraps
80106292:	e9 2c f8 ff ff       	jmp    80105ac3 <alltraps>
...
80106299:	6a 50                	push   $0x50
  jmp alltraps
8010629b:	e9 23 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801062a2:	6a 51                	push   $0x51
  jmp alltraps
801062a4:	e9 1a f8 ff ff       	jmp    80105ac3 <alltraps>
...
801062ab:	6a 52                	push   $0x52
  jmp alltraps
801062ad:	e9 11 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801062b4:	6a 53                	push   $0x53
  jmp alltraps
801062b6:	e9 08 f8 ff ff       	jmp    80105ac3 <alltraps>
...
801062bd:	6a 54                	push   $0x54
  jmp alltraps
801062bf:	e9 ff f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062c6:	6a 55                	push   $0x55
  jmp alltraps
801062c8:	e9 f6 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062cf:	6a 56                	push   $0x56
  jmp alltraps
801062d1:	e9 ed f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062d8:	6a 57                	push   $0x57
  jmp alltraps
801062da:	e9 e4 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062e1:	6a 58                	push   $0x58
  jmp alltraps
801062e3:	e9 db f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062ea:	6a 59                	push   $0x59
  jmp alltraps
801062ec:	e9 d2 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062f3:	6a 5a                	push   $0x5a
  jmp alltraps
801062f5:	e9 c9 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801062fc:	6a 5b                	push   $0x5b
  jmp alltraps
801062fe:	e9 c0 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106305:	6a 5c                	push   $0x5c
  jmp alltraps
80106307:	e9 b7 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010630e:	6a 5d                	push   $0x5d
  jmp alltraps
80106310:	e9 ae f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106317:	6a 5e                	push   $0x5e
  jmp alltraps
80106319:	e9 a5 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106320:	6a 5f                	push   $0x5f
  jmp alltraps
80106322:	e9 9c f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106329:	6a 60                	push   $0x60
  jmp alltraps
8010632b:	e9 93 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106332:	6a 61                	push   $0x61
  jmp alltraps
80106334:	e9 8a f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010633b:	6a 62                	push   $0x62
  jmp alltraps
8010633d:	e9 81 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106344:	6a 63                	push   $0x63
  jmp alltraps
80106346:	e9 78 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010634d:	6a 64                	push   $0x64
  jmp alltraps
8010634f:	e9 6f f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106356:	6a 65                	push   $0x65
  jmp alltraps
80106358:	e9 66 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010635f:	6a 66                	push   $0x66
  jmp alltraps
80106361:	e9 5d f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106368:	6a 67                	push   $0x67
  jmp alltraps
8010636a:	e9 54 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106371:	6a 68                	push   $0x68
  jmp alltraps
80106373:	e9 4b f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010637a:	6a 69                	push   $0x69
  jmp alltraps
8010637c:	e9 42 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106383:	6a 6a                	push   $0x6a
  jmp alltraps
80106385:	e9 39 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010638c:	6a 6b                	push   $0x6b
  jmp alltraps
8010638e:	e9 30 f7 ff ff       	jmp    80105ac3 <alltraps>
...
80106395:	6a 6c                	push   $0x6c
  jmp alltraps
80106397:	e9 27 f7 ff ff       	jmp    80105ac3 <alltraps>
...
8010639e:	6a 6d                	push   $0x6d
  jmp alltraps
801063a0:	e9 1e f7 ff ff       	jmp    80105ac3 <alltraps>
...
801063a7:	6a 6e                	push   $0x6e
  jmp alltraps
801063a9:	e9 15 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801063b0:	6a 6f                	push   $0x6f
  jmp alltraps
801063b2:	e9 0c f7 ff ff       	jmp    80105ac3 <alltraps>
...
801063b9:	6a 70                	push   $0x70
  jmp alltraps
801063bb:	e9 03 f7 ff ff       	jmp    80105ac3 <alltraps>
...
801063c2:	6a 71                	push   $0x71
  jmp alltraps
801063c4:	e9 fa f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063cb:	6a 72                	push   $0x72
  jmp alltraps
801063cd:	e9 f1 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063d4:	6a 73                	push   $0x73
  jmp alltraps
801063d6:	e9 e8 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063dd:	6a 74                	push   $0x74
  jmp alltraps
801063df:	e9 df f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063e6:	6a 75                	push   $0x75
  jmp alltraps
801063e8:	e9 d6 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063ef:	6a 76                	push   $0x76
  jmp alltraps
801063f1:	e9 cd f6 ff ff       	jmp    80105ac3 <alltraps>
...
801063f8:	6a 77                	push   $0x77
  jmp alltraps
801063fa:	e9 c4 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106401:	6a 78                	push   $0x78
  jmp alltraps
80106403:	e9 bb f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010640a:	6a 79                	push   $0x79
  jmp alltraps
8010640c:	e9 b2 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106413:	6a 7a                	push   $0x7a
  jmp alltraps
80106415:	e9 a9 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010641c:	6a 7b                	push   $0x7b
  jmp alltraps
8010641e:	e9 a0 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106425:	6a 7c                	push   $0x7c
  jmp alltraps
80106427:	e9 97 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010642e:	6a 7d                	push   $0x7d
  jmp alltraps
80106430:	e9 8e f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106437:	6a 7e                	push   $0x7e
  jmp alltraps
80106439:	e9 85 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106440:	6a 7f                	push   $0x7f
  jmp alltraps
80106442:	e9 7c f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106449:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010644e:	e9 70 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106455:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010645a:	e9 64 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106461:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106466:	e9 58 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010646d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106472:	e9 4c f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106479:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010647e:	e9 40 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106485:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010648a:	e9 34 f6 ff ff       	jmp    80105ac3 <alltraps>
...
80106491:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106496:	e9 28 f6 ff ff       	jmp    80105ac3 <alltraps>
...
8010649d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801064a2:	e9 1c f6 ff ff       	jmp    80105ac3 <alltraps>
...
801064a9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801064ae:	e9 10 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801064b5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801064ba:	e9 04 f6 ff ff       	jmp    80105ac3 <alltraps>
...
801064c1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801064c6:	e9 f8 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064cd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801064d2:	e9 ec f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064d9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801064de:	e9 e0 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064e5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801064ea:	e9 d4 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064f1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801064f6:	e9 c8 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801064fd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106502:	e9 bc f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106509:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010650e:	e9 b0 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106515:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010651a:	e9 a4 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106521:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106526:	e9 98 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010652d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106532:	e9 8c f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106539:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010653e:	e9 80 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106545:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010654a:	e9 74 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106551:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106556:	e9 68 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010655d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106562:	e9 5c f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106569:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010656e:	e9 50 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106575:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010657a:	e9 44 f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106581:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106586:	e9 38 f5 ff ff       	jmp    80105ac3 <alltraps>
...
8010658d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106592:	e9 2c f5 ff ff       	jmp    80105ac3 <alltraps>
...
80106599:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010659e:	e9 20 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801065a5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801065aa:	e9 14 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801065b1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801065b6:	e9 08 f5 ff ff       	jmp    80105ac3 <alltraps>
...
801065bd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801065c2:	e9 fc f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065c9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801065ce:	e9 f0 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065d5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801065da:	e9 e4 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065e1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801065e6:	e9 d8 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065ed:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801065f2:	e9 cc f4 ff ff       	jmp    80105ac3 <alltraps>
...
801065f9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801065fe:	e9 c0 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106605:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010660a:	e9 b4 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106611:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106616:	e9 a8 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010661d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106622:	e9 9c f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106629:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010662e:	e9 90 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106635:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010663a:	e9 84 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106641:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106646:	e9 78 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010664d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106652:	e9 6c f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106659:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010665e:	e9 60 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106665:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010666a:	e9 54 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106671:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106676:	e9 48 f4 ff ff       	jmp    80105ac3 <alltraps>
...
8010667d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106682:	e9 3c f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106689:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010668e:	e9 30 f4 ff ff       	jmp    80105ac3 <alltraps>
...
80106695:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010669a:	e9 24 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801066a1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801066a6:	e9 18 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801066ad:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801066b2:	e9 0c f4 ff ff       	jmp    80105ac3 <alltraps>
...
801066b9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801066be:	e9 00 f4 ff ff       	jmp    80105ac3 <alltraps>
...
801066c5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801066ca:	e9 f4 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066d1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801066d6:	e9 e8 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066dd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801066e2:	e9 dc f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066e9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801066ee:	e9 d0 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801066f5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801066fa:	e9 c4 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106701:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106706:	e9 b8 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010670d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106712:	e9 ac f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106719:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010671e:	e9 a0 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106725:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010672a:	e9 94 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106731:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106736:	e9 88 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010673d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106742:	e9 7c f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106749:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010674e:	e9 70 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106755:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010675a:	e9 64 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106761:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106766:	e9 58 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010676d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106772:	e9 4c f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106779:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010677e:	e9 40 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106785:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010678a:	e9 34 f3 ff ff       	jmp    80105ac3 <alltraps>
...
80106791:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106796:	e9 28 f3 ff ff       	jmp    80105ac3 <alltraps>
...
8010679d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801067a2:	e9 1c f3 ff ff       	jmp    80105ac3 <alltraps>
...
801067a9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801067ae:	e9 10 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801067b5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801067ba:	e9 04 f3 ff ff       	jmp    80105ac3 <alltraps>
...
801067c1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801067c6:	e9 f8 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067cd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801067d2:	e9 ec f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067d9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801067de:	e9 e0 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067e5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801067ea:	e9 d4 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067f1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801067f6:	e9 c8 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801067fd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106802:	e9 bc f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106809:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010680e:	e9 b0 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106815:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010681a:	e9 a4 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106821:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106826:	e9 98 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010682d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106832:	e9 8c f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106839:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010683e:	e9 80 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106845:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010684a:	e9 74 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106851:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106856:	e9 68 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010685d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106862:	e9 5c f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106869:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010686e:	e9 50 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106875:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010687a:	e9 44 f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106881:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106886:	e9 38 f2 ff ff       	jmp    80105ac3 <alltraps>
...
8010688d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106892:	e9 2c f2 ff ff       	jmp    80105ac3 <alltraps>
...
80106899:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010689e:	e9 20 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801068a5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801068aa:	e9 14 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801068b1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801068b6:	e9 08 f2 ff ff       	jmp    80105ac3 <alltraps>
...
801068bd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801068c2:	e9 fc f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068c9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801068ce:	e9 f0 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068d5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801068da:	e9 e4 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068e1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801068e6:	e9 d8 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068ed:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801068f2:	e9 cc f1 ff ff       	jmp    80105ac3 <alltraps>
...
801068f9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801068fe:	e9 c0 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106905:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010690a:	e9 b4 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106911:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106916:	e9 a8 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010691d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106922:	e9 9c f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106929:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010692e:	e9 90 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106935:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010693a:	e9 84 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106941:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106946:	e9 78 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010694d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106952:	e9 6c f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106959:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010695e:	e9 60 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106965:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010696a:	e9 54 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106971:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106976:	e9 48 f1 ff ff       	jmp    80105ac3 <alltraps>
...
8010697d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106982:	e9 3c f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106989:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010698e:	e9 30 f1 ff ff       	jmp    80105ac3 <alltraps>
...
80106995:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010699a:	e9 24 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801069a1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801069a6:	e9 18 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801069ad:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801069b2:	e9 0c f1 ff ff       	jmp    80105ac3 <alltraps>
...
801069b9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801069be:	e9 00 f1 ff ff       	jmp    80105ac3 <alltraps>
...
801069c5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801069ca:	e9 f4 f0 ff ff       	jmp    80105ac3 <alltraps>
...
801069d1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801069d6:	e9 e8 f0 ff ff       	jmp    80105ac3 <alltraps>
...
801069dd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801069e2:	e9 dc f0 ff ff       	jmp    80105ac3 <alltraps>
...
801069e9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801069ee:	e9 d0 f0 ff ff       	jmp    80105ac3 <alltraps>
...
801069f5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801069fa:	e9 c4 f0 ff ff       	jmp    80105ac3 <alltraps>
...
80106a01:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106a06:	e9 b8 f0 ff ff       	jmp    80105ac3 <alltraps>
...
80106a0d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106a12:	e9 ac f0 ff ff       	jmp    80105ac3 <alltraps>
...
80106a19:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106a1e:	e9 a0 f0 ff ff       	jmp    80105ac3 <alltraps>
...
80106a25:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106a2a:	e9 94 f0 ff ff       	jmp    80105ac3 <alltraps>
...
80106a31:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106a36:	e9 88 f0 ff ff       	jmp    80105ac3 <alltraps>
...
80106a3d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106a42:	e9 7c f0 ff ff       	jmp    80105ac3 <alltraps>
...
80106a5c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106a62:	83 ec 1c             	sub    $0x1c,%esp
80106a65:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106a68:	39 d3                	cmp    %edx,%ebx
80106a6a:	73 49                	jae    80106ab5 <deallocuvm.part.0+0x65>
80106a6c:	89 c7                	mov    %eax,%edi
80106a6e:	eb 0c                	jmp    80106a7c <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106a70:	83 c0 01             	add    $0x1,%eax
80106a73:	c1 e0 16             	shl    $0x16,%eax
80106a76:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106a78:	39 da                	cmp    %ebx,%edx
80106a7a:	76 39                	jbe    80106ab5 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
80106a7c:	89 d8                	mov    %ebx,%eax
80106a7e:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80106a81:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80106a84:	f6 c1 01             	test   $0x1,%cl
80106a87:	74 e7                	je     80106a70 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80106a89:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106a8b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106a91:	c1 ee 0a             	shr    $0xa,%esi
80106a94:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
80106a9a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80106aa1:	85 f6                	test   %esi,%esi
80106aa3:	74 cb                	je     80106a70 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106aa5:	8b 06                	mov    (%esi),%eax
80106aa7:	a8 01                	test   $0x1,%al
80106aa9:	75 15                	jne    80106ac0 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
80106aab:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ab1:	39 da                	cmp    %ebx,%edx
80106ab3:	77 c7                	ja     80106a7c <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80106ab5:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106abf:	c3                   	ret    
      if(pa == 0)
80106ac0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106ac5:	74 25                	je     80106aec <deallocuvm.part.0+0x9c>
      kfree(v);
80106ac7:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106aca:	05 00 00 00 80       	add    $0x80000000,%eax
80106acf:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106ad2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106ad8:	50                   	push   %eax
80106ad9:	e8 e2 b9 ff ff       	call   801024c0 <kfree>
      *pte = 0;
80106ade:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80106ae4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106ae7:	83 c4 10             	add    $0x10,%esp
80106aea:	eb 8c                	jmp    80106a78 <deallocuvm.part.0+0x28>
        panic("kfree");
80106aec:	83 ec 0c             	sub    $0xc,%esp
80106aef:	68 06 78 10 80       	push   $0x80107806
...
80106b25:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106b28:	eb 3d                	jmp    80106b67 <mappages+0x67>
...
80106b5a:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106b5c:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
80106b5f:	74 6f                	je     80106bd0 <mappages+0xd0>
    a += PGSIZE;
80106b61:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106b67:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
80106b6a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106b6d:	8d 34 18             	lea    (%eax,%ebx,1),%esi
80106b70:	89 d8                	mov    %ebx,%eax
80106b72:	c1 e8 16             	shr    $0x16,%eax
80106b75:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106b78:	8b 07                	mov    (%edi),%eax
80106b7a:	a8 01                	test   $0x1,%al
80106b7c:	75 b2                	jne    80106b30 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106b7e:	e8 fd ba ff ff       	call   80102680 <kalloc>
80106b83:	85 c0                	test   %eax,%eax
80106b85:	74 39                	je     80106bc0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106b87:	83 ec 04             	sub    $0x4,%esp
80106b8a:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106b8d:	68 00 10 00 00       	push   $0x1000
80106b92:	6a 00                	push   $0x0
80106b94:	50                   	push   %eax
80106b95:	e8 76 db ff ff       	call   80104710 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106b9a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80106b9d:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106ba0:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106ba6:	83 c8 07             	or     $0x7,%eax
80106ba9:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80106bab:	89 d8                	mov    %ebx,%eax
80106bad:	c1 e8 0a             	shr    $0xa,%eax
80106bb0:	25 fc 0f 00 00       	and    $0xffc,%eax
80106bb5:	01 d0                	add    %edx,%eax
80106bb7:	eb 92                	jmp    80106b4b <mappages+0x4b>
...
80106bdd:	68 b8 7e 10 80       	push   $0x80107eb8
...
80106bf3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106bf6:	e8 65 cd ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106c0a:	c7 80 18 18 11 80 ff 	movl   $0xffff,-0x7feee7e8(%eax)
80106c11:	ff 00 00 
80106c14:	c7 80 1c 18 11 80 00 	movl   $0xcf9a00,-0x7feee7e4(%eax)
80106c1b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106c1e:	c7 80 20 18 11 80 ff 	movl   $0xffff,-0x7feee7e0(%eax)
80106c25:	ff 00 00 
80106c28:	c7 80 24 18 11 80 00 	movl   $0xcf9200,-0x7feee7dc(%eax)
80106c2f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106c32:	c7 80 28 18 11 80 ff 	movl   $0xffff,-0x7feee7d8(%eax)
80106c39:	ff 00 00 
80106c3c:	c7 80 2c 18 11 80 00 	movl   $0xcffa00,-0x7feee7d4(%eax)
80106c43:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106c46:	c7 80 30 18 11 80 ff 	movl   $0xffff,-0x7feee7d0(%eax)
80106c4d:	ff 00 00 
80106c50:	c7 80 34 18 11 80 00 	movl   $0xcff200,-0x7feee7cc(%eax)
80106c57:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106c5a:	05 10 18 11 80       	add    $0x80111810,%eax
  pd[1] = (uint)p;
...
80106c80:	a1 c4 e4 11 80       	mov    0x8011e4c4,%eax
...
80106cb4:	0f 84 c2 00 00 00    	je     80106d7c <switchuvm+0xec>
  pushcli();
80106cba:	e8 41 d8 ff ff       	call   80104500 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106cbf:	e8 3c cc ff ff       	call   80103900 <mycpu>
80106cc4:	89 c3                	mov    %eax,%ebx
80106cc6:	e8 35 cc ff ff       	call   80103900 <mycpu>
80106ccb:	89 c7                	mov    %eax,%edi
80106ccd:	e8 2e cc ff ff       	call   80103900 <mycpu>
80106cd2:	83 c7 08             	add    $0x8,%edi
80106cd5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106cd8:	e8 23 cc ff ff       	call   80103900 <mycpu>
...
80106daf:	8b 7d 08             	mov    0x8(%ebp),%edi
80106db2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106db5:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106dbb:	77 4b                	ja     80106e08 <inituvm+0x68>
  mem = kalloc();
80106dbd:	e8 be b8 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106dcf:	e8 3c d9 ff ff       	call   80104710 <memset>
...
80106de8:	e8 13 fd ff ff       	call   80106b00 <mappages>
  memmove(mem, init, sz);
80106ded:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106df0:	89 75 10             	mov    %esi,0x10(%ebp)
80106df3:	83 c4 10             	add    $0x10,%esp
80106df6:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106df9:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106e02:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106e03:	e9 a8 d9 ff ff       	jmp    801047b0 <memmove>
    panic("inituvm: more than a page");
80106e08:	83 ec 0c             	sub    $0xc,%esp
80106e0b:	68 fd 7e 10 80       	push   $0x80107efd
80106e10:	e8 6b 95 ff ff       	call   80100380 <panic>
...
80106e2c:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106e2f:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106e34:	0f 85 bb 00 00 00    	jne    80106ef5 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
80106e3a:	01 f0                	add    %esi,%eax
80106e3c:	89 f3                	mov    %esi,%ebx
80106e3e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106e41:	8b 45 14             	mov    0x14(%ebp),%eax
80106e44:	01 f0                	add    %esi,%eax
80106e46:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106e49:	85 f6                	test   %esi,%esi
80106e4b:	0f 84 87 00 00 00    	je     80106ed8 <loaduvm+0xb8>
80106e51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80106e58:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
80106e5b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106e5e:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80106e60:	89 c2                	mov    %eax,%edx
80106e62:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106e65:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80106e68:	f6 c2 01             	test   $0x1,%dl
80106e6b:	75 13                	jne    80106e80 <loaduvm+0x60>
      panic("loaduvm: address should exist");
80106e6d:	83 ec 0c             	sub    $0xc,%esp
80106e70:	68 17 7f 10 80       	push   $0x80107f17
80106e75:	e8 06 95 ff ff       	call   80100380 <panic>
80106e7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106e80:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106e83:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80106e89:	25 fc 0f 00 00       	and    $0xffc,%eax
80106e8e:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106e95:	85 c0                	test   %eax,%eax
80106e97:	74 d4                	je     80106e6d <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
80106e99:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106e9b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
80106e9e:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80106ea3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106ea8:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
80106eae:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106eb1:	29 d9                	sub    %ebx,%ecx
80106eb3:	05 00 00 00 80       	add    $0x80000000,%eax
80106eb8:	57                   	push   %edi
80106eb9:	51                   	push   %ecx
80106eba:	50                   	push   %eax
80106ebb:	ff 75 10             	push   0x10(%ebp)
80106ebe:	e8 cd ab ff ff       	call   80101a90 <readi>
80106ec3:	83 c4 10             	add    $0x10,%esp
80106ec6:	39 f8                	cmp    %edi,%eax
80106ec8:	75 1e                	jne    80106ee8 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106eca:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106ed0:	89 f0                	mov    %esi,%eax
80106ed2:	29 d8                	sub    %ebx,%eax
80106ed4:	39 c6                	cmp    %eax,%esi
80106ed6:	77 80                	ja     80106e58 <loaduvm+0x38>
}
...
80106ee8:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80106eeb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80106ef0:	5b                   	pop    %ebx
80106ef1:	5e                   	pop    %esi
80106ef2:	5f                   	pop    %edi
...
80106ef8:	68 b8 7f 10 80       	push   $0x80107fb8
80106efd:	e8 7e 94 ff ff       	call   80100380 <panic>
...
80106f5b:	e8 b0 d7 ff ff       	call   80104710 <memset>
...
80106f74:	e8 87 fb ff ff       	call   80106b00 <mappages>
...
80106f89:	76 48                	jbe    80106fd3 <allocuvm+0xc3>
    mem = kalloc();
80106f8b:	e8 f0 b6 ff ff       	call   80102680 <kalloc>
...
80106f99:	68 35 7f 10 80       	push   $0x80107f35
...
80106fb5:	e8 96 fa ff ff       	call   80106a50 <deallocuvm.part.0>
      return 0;
...
80106ffb:	68 4d 7f 10 80       	push   $0x80107f4d
...
80107017:	e8 34 fa ff ff       	call   80106a50 <deallocuvm.part.0>
      kfree(mem);
8010701c:	83 ec 0c             	sub    $0xc,%esp
8010701f:	53                   	push   %ebx
80107020:	e8 9b b4 ff ff       	call   801024c0 <kfree>
      return 0;
...
80107050:	5d                   	pop    %ebp
80107051:	e9 fa f9 ff ff       	jmp    80106a50 <deallocuvm.part.0>
...
8010708b:	e8 c0 f9 ff ff       	call   80106a50 <deallocuvm.part.0>
...
801070be:	e8 fd b3 ff ff       	call   801024c0 <kfree>
...
801070d3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801070d4:	e9 e7 b3 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
801070d9:	83 ec 0c             	sub    $0xc,%esp
801070dc:	68 69 7f 10 80       	push   $0x80107f69
...
801070f5:	e8 86 b5 ff ff       	call   80102680 <kalloc>
...
80107110:	e8 fb d5 ff ff       	call   80104710 <memset>
...
8010717b:	a3 c4 e4 11 80       	mov    %eax,0x8011e4c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801071ac:	68 7a 7f 10 80       	push   $0x80107f7a
...
801071f3:	0f 84 bd 00 00 00    	je     801072b6 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80107222:	68 84 7f 10 80       	push   $0x80107f84
...
8010725f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107265:	e8 16 b4 ff ff       	call   80102680 <kalloc>
...
80107280:	e8 2b d5 ff ff       	call   801047b0 <memmove>
...
8010729b:	e8 60 f8 ff ff       	call   80106b00 <mappages>
...
801072b0:	0f 87 5a ff ff ff    	ja     80107210 <copyuvm+0x30>
  return d;
...
801072cc:	e8 ef b1 ff ff       	call   801024c0 <kfree>
      goto bad;
...
801072da:	e8 91 fd ff ff       	call   80107070 <freevm>
  return 0;
801072df:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
801072f7:	68 9e 7f 10 80       	push   $0x80107f9e
...
80107324:	0f 84 5c 02 00 00    	je     80107586 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107334:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107339:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
...
80107347:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
8010734a:	05 00 00 00 80       	add    $0x80000000,%eax
8010734f:	83 fa 05             	cmp    $0x5,%edx
80107352:	ba 00 00 00 00       	mov    $0x0,%edx
80107357:	0f 45 c2             	cmovne %edx,%eax
}
8010735a:	c3                   	ret    
...
80107376:	e9 a5 00 00 00       	jmp    80107420 <copyout+0xc0>
...
80107392:	74 75                	je     80107409 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
...
80107396:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
80107399:	29 c3                	sub    %eax,%ebx
8010739b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801073a1:	39 f3                	cmp    %esi,%ebx
801073a3:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
801073a6:	29 f8                	sub    %edi,%eax
801073a8:	83 ec 04             	sub    $0x4,%esp
801073ab:	01 c1                	add    %eax,%ecx
801073ad:	53                   	push   %ebx
801073ae:	52                   	push   %edx
801073af:	51                   	push   %ecx
801073b0:	e8 fb d3 ff ff       	call   801047b0 <memmove>
    len -= n;
    buf += n;
...
801073c5:	74 59                	je     80107420 <copyout+0xc0>
  if(*pde & PTE_P){
...
801073dd:	0f 84 aa 01 00 00    	je     8010758d <copyout.cold>
  return &pgtab[PTX(va)];
...
801073fd:	83 e1 05             	and    $0x5,%ecx
80107400:	83 f9 05             	cmp    $0x5,%ecx
80107403:	0f 84 77 ff ff ff    	je     80107380 <copyout+0x20>
  }
  return 0;
}
...
80107436:	83 ec 1c             	sub    $0x1c,%esp
  ...
  a = (char*)PGROUNDDOWN((uint)va);
80107439:	8b 75 0c             	mov    0xc(%ebp),%esi
  last = (char*)PGROUNDUP(((uint)va) + size);
8010743c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010743f:	03 45 10             	add    0x10(%ebp),%eax
void* map_pages(pde_t *pgdir, void *va, uint size, int perm) {
80107442:	8b 7d 08             	mov    0x8(%ebp),%edi
  last = (char*)PGROUNDUP(((uint)va) + size);
80107445:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107448:	05 ff 0f 00 00       	add    $0xfff,%eax
  a = (char*)PGROUNDDOWN((uint)va);
8010744d:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  last = (char*)PGROUNDUP(((uint)va) + size);
80107453:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107458:	89 45 e4             	mov    %eax,-0x1c(%ebp)

  for (; a < last; a += PGSIZE) {
8010745b:	39 c6                	cmp    %eax,%esi
8010745d:	72 45                	jb     801074a4 <map_pages+0x74>
8010745f:	eb 6f                	jmp    801074d0 <map_pages+0xa0>
...
8010746b:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
    memset((void*)pa, 0, PGSIZE);  // Zero out the physical memory
80107471:	68 00 10 00 00       	push   $0x1000
80107476:	6a 00                	push   $0x0
80107478:	50                   	push   %eax
80107479:	e8 92 d2 ff ff       	call   80104710 <memset>
    if (mappages(pgdir, a, PGSIZE, V2P(pa), perm) < 0) {
8010747e:	58                   	pop    %eax
8010747f:	5a                   	pop    %edx
80107480:	ff 75 14             	push   0x14(%ebp)
80107483:	53                   	push   %ebx
80107484:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107489:	89 f2                	mov    %esi,%edx
8010748b:	89 f8                	mov    %edi,%eax
8010748d:	e8 6e f6 ff ff       	call   80106b00 <mappages>
80107492:	83 c4 10             	add    $0x10,%esp
80107495:	85 c0                	test   %eax,%eax
80107497:	78 47                	js     801074e0 <map_pages+0xb0>
  for (; a < last; a += PGSIZE) {
80107499:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010749f:	39 75 e4             	cmp    %esi,-0x1c(%ebp)
801074a2:	76 2c                	jbe    801074d0 <map_pages+0xa0>
    if ((pa = (uint)kalloc()) == 0) {
801074a4:	e8 d7 b1 ff ff       	call   80102680 <kalloc>
801074a9:	89 c3                	mov    %eax,%ebx
801074ab:	85 c0                	test   %eax,%eax
801074ad:	75 b9                	jne    80107468 <map_pages+0x38>
  if(newsz >= oldsz)
801074af:	8b 45 e0             	mov    -0x20(%ebp),%eax
801074b2:	39 45 0c             	cmp    %eax,0xc(%ebp)
801074b5:	73 0c                	jae    801074c3 <map_pages+0x93>
801074b7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801074ba:	89 c2                	mov    %eax,%edx
801074bc:	89 f8                	mov    %edi,%eax
801074be:	e8 8d f5 ff ff       	call   80106a50 <deallocuvm.part.0>
...
801074cd:	8d 76 00             	lea    0x0(%esi),%esi
  return va;  // Success
801074d0:	8b 5d 0c             	mov    0xc(%ebp),%ebx
}
801074d3:	8d 65 f4             	lea    -0xc(%ebp),%esp
801074d6:	89 d8                	mov    %ebx,%eax
801074d8:	5b                   	pop    %ebx
801074d9:	5e                   	pop    %esi
801074da:	5f                   	pop    %edi
801074db:	5d                   	pop    %ebp
...
801074dd:	8d 76 00             	lea    0x0(%esi),%esi
  if(newsz >= oldsz)
801074e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801074e3:	39 45 0c             	cmp    %eax,0xc(%ebp)
801074e6:	73 0c                	jae    801074f4 <map_pages+0xc4>
801074e8:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801074eb:	89 c2                	mov    %eax,%edx
801074ed:	89 f8                	mov    %edi,%eax
801074ef:	e8 5c f5 ff ff       	call   80106a50 <deallocuvm.part.0>
      kfree((char*)P2V(pa));  // Free the allocated physical memory
801074f4:	83 ec 0c             	sub    $0xc,%esp
801074f7:	53                   	push   %ebx
      return 0;  // Failed to map the page
801074f8:	31 db                	xor    %ebx,%ebx
      kfree((char*)P2V(pa));  // Free the allocated physical memory
801074fa:	e8 c1 af ff ff       	call   801024c0 <kfree>
      return 0;  // Failed to map the page
801074ff:	83 c4 10             	add    $0x10,%esp
}
80107502:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107505:	89 d8                	mov    %ebx,%eax
80107507:	5b                   	pop    %ebx
80107508:	5e                   	pop    %esi
80107509:	5f                   	pop    %edi
8010750a:	5d                   	pop    %ebp
...
80107514:	8b 55 0c             	mov    0xc(%ebp),%edx
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDUP(((uint)va) + size);
80107517:	8b 4d 10             	mov    0x10(%ebp),%ecx
int is_region_free(pde_t *pgdir, void *va, uint size) {
8010751a:	53                   	push   %ebx
8010751b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  a = (char*)PGROUNDDOWN((uint)va);
8010751e:	89 d0                	mov    %edx,%eax
  last = (char*)PGROUNDUP(((uint)va) + size);
80107520:	8d 8c 0a ff 0f 00 00 	lea    0xfff(%edx,%ecx,1),%ecx
  a = (char*)PGROUNDDOWN((uint)va);
80107527:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  last = (char*)PGROUNDUP(((uint)va) + size);
8010752c:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx

  for (; a < last; a += PGSIZE) {
80107532:	39 c8                	cmp    %ecx,%eax
80107534:	73 41                	jae    80107577 <is_region_free+0x67>
80107536:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010753d:	8d 76 00             	lea    0x0(%esi),%esi
  pde = &pgdir[PDX(va)];
80107540:	89 c2                	mov    %eax,%edx
80107542:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80107545:	8b 14 93             	mov    (%ebx,%edx,4),%edx
80107548:	f6 c2 01             	test   $0x1,%dl
8010754b:	74 21                	je     8010756e <is_region_free+0x5e>
  return &pgtab[PTX(va)];
8010754d:	89 c6                	mov    %eax,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010754f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80107555:	c1 ee 0a             	shr    $0xa,%esi
80107558:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
8010755e:	8d 94 32 00 00 00 80 	lea    -0x80000000(%edx,%esi,1),%edx
    if ((pte = walkpgdir(pgdir, a, 0)) == 0)
80107565:	85 d2                	test   %edx,%edx
80107567:	74 05                	je     8010756e <is_region_free+0x5e>
      continue;  // Page table entry does not exist, consider as free

    if (*pte & PTE_P)
80107569:	f6 02 01             	testb  $0x1,(%edx)
8010756c:	75 12                	jne    80107580 <is_region_free+0x70>
  for (; a < last; a += PGSIZE) {
8010756e:	05 00 10 00 00       	add    $0x1000,%eax
80107573:	39 c1                	cmp    %eax,%ecx
80107575:	77 c9                	ja     80107540 <is_region_free+0x30>
...
80107577:	5b                   	pop    %ebx
  return 1;  // Region is free
80107578:	b8 01 00 00 00       	mov    $0x1,%eax
}
8010757d:	5e                   	pop    %esi
8010757e:	5d                   	pop    %ebp
8010757f:	c3                   	ret    
...
80107586 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107586:	a1 00 00 00 00       	mov    0x0,%eax
8010758b:	0f 0b                	ud2    

8010758d <copyout.cold>:
